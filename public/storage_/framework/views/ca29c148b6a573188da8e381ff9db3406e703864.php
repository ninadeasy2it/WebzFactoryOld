            ...
            <div class="p-3 card">
                <ul class="nav nav-pills nav-fill" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="theme-setting-tab" data-bs-toggle="pill"
                            data-bs-target="#theme-setting" type="button"><?php echo e(__('Theme')); ?></button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="details-setting-tab" data-bs-toggle="pill"
                            data-bs-target="#details-setting" type="button"><?php echo e(__('Details')); ?></button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="domain-setting-tab" data-bs-toggle="pill"
                            data-bs-target="#domain-setting" type="button"><?php echo e(__('Custom')); ?></button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="block-setting-tab" data-bs-toggle="pill"
                            data-bs-target="#block-setting" type="button"><?php echo e(__('Change Blocks')); ?></button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="seo-setting-tab" data-bs-toggle="pill" data-bs-target="#seo-setting"
                            type="button"><?php echo e(__('SEO')); ?></button>
                    </li>
                </ul>
            </div>
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="theme-setting" role="tabpanel"
                ...
                <div class="tab-pane fade" id="details-setting" role="tabpanel" aria-labelledby="pills-user-tab-2">
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="card">
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <?php echo e(Form::text('sub_title', $business->sub_title, ['class' => 'form-control emojiarea', 'id' => $stringid . '_subtitle', 'placeholder' => __('Enter Sub Title')])); ?>
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <?php echo e(Form::textarea('description', $business->description, ['class' => 'form-control description-text emojiarea','rows' => '3', 'id' => $stringid . '_desc', 'placeholder' => __('Enter Description')])); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="tab-pane fade" id="domain-setting" role="tabpanel" aria-labelledby="pills-user-tab-3">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php endif; ?>
                    <div class="tab-pane fade" id="block-setting" role="tabpanel" aria-labelledby="pills-user-tab-4">
                        <div class="">
                            <div class="row">
                                <div class="col-lg-12">
                    ...
                    <div class="tab-pane fade" id="seo-setting" role="tabpanel" aria-labelledby="pills-user-tab-4">
                        <div class="">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
