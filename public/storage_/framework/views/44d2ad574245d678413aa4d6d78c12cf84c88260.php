...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme2/css/bootstrap.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme2/modal/bootstrap.min.css')); ?>">
    <script src="<?php echo e(asset('custom/theme2/modal/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(asset('custom/theme2/modal/bootstrap.min.js')); ?>"></script>
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme2/fontawesome-free/css/all.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('custom/css/emojionearea.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/plugins/animate.min.css')); ?>" />
    <?php endif; ?>
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme2/css/styles/'.$business->theme_color.'/style.css')); ?>">
    <?php if(isset($is_slug)): ?>
...
<body>
                    ...
                    <div class="banner-image">
                        ...
                        <div class="media align-items-center justify-content-center profile-head">
                            <div class="profile">
                                ...
                                <img src="<?php echo e(isset($business->logo) && !empty($business->logo) ? $logo . '/' . $business->logo : asset('custom/img/logo-placeholder-image-2.png')); ?>" id="business_logo_preview" alt="user" class="mb-4 img-thumbnail">
                            </div>
                        </div>
                    </div>
                                                ...
                                                <?php if(isset($contactinfo['is_enabled']) && $contactinfo['is_enabled'] == '1'): ?>
                                                    <?php $__currentLoopData = $contactinfo_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php $__currentLoopData = $val; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key1 => $val1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <?php endif; ?>
                                                            <?php if($key1 != 'id'): ?>
                                                                <li class="d-flex align-items-center justify-content-start" id="contact_<?php echo e($loop->parent->index+1); ?>">
                                                                    <div class="image-icon">
                                                                        <img src="<?php echo e(asset('custom/theme2/icon/'.$color.'/contact/'.strtolower($key1).'.svg')); ?>" alt="<?php echo e($key1); ?>" class="img-fluid">
                                                                    </div>
                                                                    ...
                                                                    <a href="<?php echo e($href); ?>" target="_blank">
                                                                        <?php $__currentLoopData = $val1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2 => $val2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php if($key2 == "Address"): ?>
                                                                            <h4 id="<?php echo e($key1.'_'.$no); ?>_preview"><?php echo e($val2); ?></h4>
                                                                        <?php endif; ?> 
                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                ...
                                                                <?php if($key1 == 'Whatsapp'): ?>
                                                                    <a href="<?php echo e(url('https://wa.me/'.$href)); ?>" target="_blank">
                                                                <?php else: ?>
                                                                    <a href="<?php echo e($href); ?>" target="_blank">
                                                                <?php endif; ?>    
                                                                    <h4 id="<?php echo e($key1.'_'.$no); ?>_preview"><?php echo e($val1); ?></h4>
                                                                </a>
                                                                <?php endif; ?>
                                                                    </div>
                                                                </li>
                                        ...
                                        <div class="">
                                            <ul>
                                                <li class="d-flex align-items-center justify-content-start">
                                                    <div class="image-icon">
                                                        <img src="<?php echo e(asset('custom/theme2/icon/'.$color.'/clock.svg')); ?>" alt="clock" class="img-fluid">
                                                    </div>
                                                    <div class="contact-text">
                                        ...
                                        <div class="card-business-hours">
                                            <ul>
                                                <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li>
                                                        <p><?php echo e(__($day)); ?>:<span class="days_<?php echo e($k); ?>"> <?php if(isset($business_hours->$k) && $business_hours->$k->days=='on'): ?> 
                                                            <span class="days_<?php echo e($k); ?>_start"><?php echo e(!empty($business_hours->$k->start_time) && isset($business_hours->$k->start_time) ? $business_hours->$k->start_time : '00:00'); ?></span>-<span class="days_<?php echo e($k); ?>_end"><?php echo e(!empty($business_hours->$k->end_time) && isset($business_hours->$k->end_time) ? $business_hours->$k->end_time : '00:00'); ?></span>
                                                                <?php else: ?>
                                                                Closed
                                                                <?php endif; ?>
                                                            </span>
                                    ...
                                    <div class="card-contact">
                                        <div class="">
                                            <ul>
                                                <li class="d-flex align-items-center justify-content-start">
                                                    <div class="image-icon">
                                                        <img src="<?php echo e(asset('custom/theme2/icon/'.$color.'/calender.svg')); ?>" alt="calendar" class="img-fluid">
                                                    </div>
                                                    <div class="contact-text">
                                                        <h3> <span> <?php echo e(__('Make an')); ?> </span> <?php echo e(__('appointment')); ?></h3>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div><br>
                                        <div class="text-center card-business-hours">
                                            <form action="" class="datepicker-form">
                                                <div class="date-click d-flex">
                                                    <fieldset class="d-flex align-items-center w-100">
                                                        <div class="lable-custom">
                                                            <label for="input_from" class="Date appointment-lable"><?php echo e(__('Date')); ?></label>
                                                        </div>
                                                ...
                                                <div class="hour-click d-flex ">
                                                    <div class="lable-custom">
                                                        <label for="input_from" class="radio-label appointment-lable"><?php echo e(__('Hour')); ?></label>
                                                    </div>
                                                ...
                                                <div class="make-an-appointment d-flex">
                                                    ...
                                                    <div class="make-an-appointment-btn">
                                                        <button type="button" data-toggle="modal" data-target="#appointment-modal"
                                                            ...
                                                            <img src="<?php echo e(asset('custom/theme2/icon/'.$color.'/calender-black.svg')); ?>" alt="calender-black"
                                                                class="img-fluid">
                                    ...
                                    <div class="card-contact">
                                        <div class="">
                                            <ul>
                                                <li class="d-flex align-items-center justify-content-start">
                                                    <div class="image-icon">
                                                        <img src="<?php echo e(asset('custom/theme2/icon/'.$color.'/call2.svg')); ?>" alt="call2" class="img-fluid">
                                                    </div>
                                                    <div class="contact-text">
                                            ...
                                            <div class="row" id="inputrow_service_preview">
                                                <?php $image_count = 0; ?>    
                                                    <?php $__currentLoopData = $services_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k1 => $content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>    
                                                        <div class="col-lg-6" id="services_<?php echo e($service_row_no); ?>">
                                                            <div class="service-card pb-3">
                                                                ...
                                                                <div class="service-card-heading">
                                                                    <h3 id="<?php echo e('title_'.$service_row_no.'_preview'); ?>">
                                ...
                                <div class="card-contact">
                                    <div class="">
                                        <ul>
                                            <li class="d-flex align-items-center justify-content-start">
                                                <div class="image-icon">
                                                    <img src="<?php echo e(asset('custom/theme2/icon/'.$color.'/more.svg')); ?>" alt="bookmark" class="img-fluid">
                                                </div>
                                                <div class="contact-text">
                                ...
                                <div class="card-contact pt-0">
                                    <div class="text-center card-business-hours">
                                        <div class="make-an-appointment d-flex mb-3">
                                            <div class="w-100">
                                                <button type="button"
                                                    class="make-an-appointment-btn-main d-flex align-items-center justify-content-center w-100"  onclick="location.href = '<?php echo e(route('bussiness.save',$business->slug)); ?>'">
                                                    <img src="<?php echo e(asset('custom/theme2/icon/'.$color.'/save.svg')); ?>" alt="folder" class="img-fluid">
                                        ...
                                        <div class="make-an-appointment d-flex mb-3">
                                            <div class="w-100">
                                                <button type="button"
                                                    ...
                                                    <img src="<?php echo e(asset('custom/theme2/icon/'.$color.'/share.svg')); ?>" alt="signout" class="img-fluid">
                                        ...
                                        <div class="make-an-appointment d-flex mb-3">
                                            <div class="w-100">
                                                <button type="button"
                                                    ...
                                                    <img src="<?php echo e(asset('custom/icon/phone.svg')); ?>" alt="signout" class="img-fluid">
                                        ...
                                        <div class="text-center card-business-hours pb-0">
                                            <div class="container-lg">
                                                ...
                                                <?php $__currentLoopData = $testimonials_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k2 => $testi_content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="col-lg-6 pr-8 pl-0 res-pr-0" id="testimonials_<?php echo e($testimonials_row_no); ?>">
                                                        <div class="service-card testimonials-card">
                                                            ...
                                                            <div class="service-card-heading">
                                                                ...
                                                                ?>
                                                                <span id="<?php echo e('stars'.$testimonials_row_no); ?>_star" class="star-section d-flex align-items-center justify-content-center">
                                                                <?php for($i=1; $i<=5; $i++): ?>
                                                                ...
                                                                <p id="<?php echo e('testimonial_description_'.$testimonials_row_no.'_preview'); ?>">
                                ...
                                <div id="social-div">
                                    ...
                                    <div class="card-contact">
                                        <div class="">
                                            <ul>
                                                <li class="d-flex align-items-center justify-content-start">
                                                    <div class="image-icon">
                                                        <img src="<?php echo e(asset('custom/theme2/icon/'.$color.'/social.svg')); ?>" alt="bookmark" class="img-fluid">
                                                    </div>
                                                    <div class="contact-text">
                                                        <h3> <span> </span> <?php echo e(__('Social')); ?></h3>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="social-icon">
                                        <div class="text-center card-business-hours pb-20 res-pt-0e">
                                            <div class="container-lg">
                                                <div class="row">
                                                    <div class="social-icon-main w-100">
                                                            ...
                                                            <?php $__currentLoopData = $social_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social_key => $social_val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <?php $__currentLoopData = $social_val; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social_key1 => $social_val1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <?php if($social_key1 != 'id'): ?>
                                                                        <div class="col-3 social-image-icon mb-3 socials_<?php echo e($loop->parent->index+1); ?>" id="socials_<?php echo e($loop->parent->index+1); ?>">
                                                                            <a href="<?php echo e(url($social_val1)); ?>" class="social_link_<?php echo e($loop->parent->index+1); ?>_href_preview" id="social_link_<?php echo e($loop->parent->index+1); ?>_href_preview'}}"  target="_blank">
                                                                                <img src="<?php echo e(asset('custom/theme2/icon/'.$color.'/social/'.strtolower($social_key1).'.svg')); ?>" alt="<?php echo e($social_key1); ?>"
                                                                                    class="img-fluid hover-hide">
                                                                                <img src="<?php echo e(asset('custom/theme2/icon/'.$color.'/social_white/'.strtolower($social_key1).'.svg')); ?>" alt="<?php echo e($social_key1); ?>"
                ...
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        ...
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center"
                            data-dismiss="modal">
                            <img src="<?php echo e(asset('custom/theme2/icon/close.svg')); ?>" alt="back" class="img-fluid">
                        </button>
                    </div>
                </div>
                <div class="modal-body px-4">
                    <form class="appointment-form">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" placeholder="<?php echo e(__('Enter your name')); ?>" class="form-control app_name"
                                id="recipient-name">
                            <div class="">
            ...
            <div class="modal-content">
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center"
                            data-dismiss="modal">
                            <img src="<?php echo e(asset('custom/theme2/img/back.svg')); ?>" alt="back" class="img-fluid">
                        </button>
                    ...
                    <div class="modal-body-section text-center">
                        <div class="qr-main-image">
                            <div class="qr-code-border">
                                <img src="<?php echo e(asset('custom/theme2/icon/left-top.svg')); ?>" alt="left-top" class="img-fluid left-top-border">
                                <img src="<?php echo e(asset('custom/theme2/icon/left-bottom.svg')); ?>" alt="left-bottom"
                                    class="img-fluid left-bottom-border">
                                <img src="<?php echo e(asset('custom/theme2/icon/right-top.svg')); ?>" alt="right-top" class="img-fluid right-top-border">
                                <img src="<?php echo e(asset('custom/theme2/icon/right-bottom.svg')); ?>" alt="right-bottom"
                        ...
                        <div class="text">
                            <p>
                                <?php echo e(__('Point your camera at the QR code, or visit')); ?> <span class="qr-link text-center mr-2"></span>
                            </p>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body px-4">
                    <form action="<?php echo e(route('contacts.store')); ?>" method="post">
                      ...
                      <div class="form-group">
                        <label for="recipient-name" class="col-form-label"><?php echo e(__('Name')); ?>:</label>
                        <input type="text" name="name" placeholder="<?php echo e(__('Enter your name')); ?>" class="form-control" id="recipient-name">
                      </div>
                      <div class="form-group">
                        <label for="message-text" class="col-form-label"><?php echo e(__('Email')); ?>:</label>
                       <input type="email" name="email" placeholder="<?php echo e(__('Enter your email')); ?>" class="form-control" id="recipient-name">
                   </div>
                        <div class="form-group">
                        <label for="message-text" class="col-form-label"><?php echo e(__('Phone')); ?>:</label>
                       <input type="text" name="phone" placeholder="<?php echo e(__('Enter your phone no.')); ?>" class="form-control" id="recipient-name">
                      </div>
                ...
                <div class="modal-body px-4">
                    <form class="appointment-form">
                      <div class="form-group">
                        ...
                        <input type="password" name="Password" placeholder="<?php echo e(__('Enter password')); ?>" class="form-control password_val" id="recipient-name" placeholder="Password">
                        <div class="">
                            <span class="text-danger  h5 span-error-password"></span>
                        </div>
                     </div>
                     <div class="form-btn-group ">
                        <button type="button" class="btn form-btn--submit password-submit"><?php echo e(__('Submit')); ?></button>
                        </div>
                    </form> 
                  </div>
   ...
   <noscript><img height="1" width="1" style="display:none"
     src="https://www.facebook.com/tr?id=0000&ev=PageView&noscript=<?php echo e($business->fbpixel_code); ?>"
   /></noscript>
...
</html><?php /**PATH C:\wamp64\www\WebzFactoryOld\resources\views/card/theme2/index.blade.php ENDPATH**/ ?>