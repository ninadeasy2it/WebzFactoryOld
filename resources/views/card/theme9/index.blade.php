...
<head>
    ...
    @if (isset($is_slug))
        <link rel="stylesheet" href="{{ asset('custom/theme9/css/bootstrap.min.css') }}">
        <link rel="stylesheet" href="{{ asset('custom/theme9/modal/bootstrap.min.css') }}">
        <script src="{{ asset('custom/theme9/modal/jquery.min.js') }}"></script>
        <script src="{{ asset('custom/theme9/modal/bootstrap.min.js') }}"></script>
        <link rel="stylesheet" href="{{ asset('custom/theme9/fontawesome-free/css/all.min.css') }}">
        <link rel="stylesheet" href="{{ asset('custom/css/emojionearea.min.css') }}">
        <link rel="stylesheet" href="{{asset('assets/css/plugins/animate.min.css')}}" />
    @endif
    <link rel="stylesheet" href="{{ asset('custom/theme9/css/styles/' . $business->theme_color . '/style.css') }}">
    @if (isset($is_slug))
                                ...
                                <div class="profile-head">
                                    <div class="align-items-center justify-content-center profile-head-main">
                                        <div class="vcard-description">
                                            ...
                                            <p id="{{ $stringid . '_subtitle' }}_preview" class="text-white">{{ $business->sub_title }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="make-an-appointment d-flex mr-2">
                                                <span class="w-100" tabindex="0" data-toggle="tooltip"
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        <img src="{{ asset('custom/theme9/icon/save.svg') }}"
                                            ...
                                            <div class="make-an-appointment d-flex mr-2">
                                                <span class="w-100" tabindex="0" data-toggle="tooltip"
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        <img src="{{ asset('custom/theme9/icon/signout.svg') }}"
                                            ...
                                            <div class="make-an-appointment d-flex mr-2">
                                                <span class="w-100" tabindex="0" data-toggle="tooltip"
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        <img src="{{ asset('custom/theme9/icon/call.svg') }}"
                                                            alt="folder" class="img-fluid">
                                                        <!-- <h4 class="text-white">{{ __('Save card') }}</h4> -->
                                                    </button>
                                                </span>
                                                        ...
                                                        <div class="service-card pb-3">
                                                            <div class="service-card-img">
                                                                {{-- <img id="{{ 's_image' . $image_count . '_preview' }}"
                                                                    src="{{ !empty($content->image) ? asset(Storage::url('service_images/' . $content->image)) : asset('custom/theme9/icon/image.svg') }}"
                ...
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        ...
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center"
                            data-dismiss="modal">
                            <img src="{{ asset('custom/theme9/icon/close.svg') }}" alt="back" class="img-fluid">
                        </button>
                    </div>
                </div>
            ...
            <div class="modal-content">
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center"
                            data-dismiss="modal">
                            <img src="{{ asset('custom/theme9/img/back.svg') }}" alt="back" class="img-fluid">
                        </button>
                        <h4 class="modal-title">{{ __('Share this card') }}</h4>
                        <button type="button" class="logout-btn">
                            {{-- <img src="{{ asset('custom/theme9/icon/signout.svg') }}" alt="signout"
                                class="img-fluid"> --}}
                        </button>
                    </div>
                </div>
                    ...
                    <div class="modal-body-section text-center">
                        <div class="qr-main-image">
                            <div class="qr-code-border">
                                <img src="{{ asset('custom/theme9/icon/left-top.svg') }}" alt="left-top"
                                    class="img-fluid left-top-border">
                                <img src="{{ asset('custom/theme9/icon/left-bottom.svg') }}" alt="left-bottom"
                                    class="img-fluid left-bottom-border">
                                <img src="{{ asset('custom/theme9/icon/right-top.svg') }}" alt="right-top"
                                    class="img-fluid right-top-border">
                                <img src="{{ asset('custom/theme9/icon/right-bottom.svg') }}" alt="right-bottom"
                                                ...
                                                @if ($social_key1 != 'id')
                                                    <div class="col-1 p-0 socials_{{ $loop->parent->index + 1 }}"
                                                        ...
                                                        <div class="image-icon">
                                                            <a href="{{ $social_val1 }}">
                                                                <img src="{{ asset('custom/theme9/icon/modal/' . strtolower($social_key1) . '.svg') }}"
