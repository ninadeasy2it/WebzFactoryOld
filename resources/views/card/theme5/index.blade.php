...
<head>
    ...
    @if (isset($is_slug))
        <link rel="stylesheet" href="{{ asset('custom/theme5/css/bootstrap.min.css') }}">
        <link rel="stylesheet" href="{{ asset('custom/theme5/modal/bootstrap.min.css') }}">
        <script src="{{ asset('custom/theme5/modal/jquery.min.js') }}"></script>
        <script src="{{ asset('custom/theme5/modal/bootstrap.min.js') }}"></script>
        <link rel="stylesheet" href="{{ asset('custom/theme5/fontawesome-free/css/all.min.css') }}">
        <link rel="stylesheet" href="{{ asset('custom/css/emojionearea.min.css') }}">
        <link rel="stylesheet" href="{{asset('assets/css/plugins/animate.min.css')}}" />
    @endif
    <link rel="stylesheet" href="{{ asset('custom/theme5/css/styles/' . $business->theme_color . '/style.css') }}">
    @if (isset($is_slug))
                    ...
                    <div class="banner-card-header">
                                    ...
                                    <div class="align-items-center justify-content-center profile-head-main">
                                        <div class="profile-qr-code">
                                            {{-- <img src="{{ isset($business->logo) && !empty($business->logo) ? asset(Storage::url('card_logo/' . $business->logo)) : asset('custom/img/logo-placeholder-image-2.png') }}"
                                                id="business_logo_preview" alt="user" class="img-fluid"> --}}
                                                <img src="{{ isset($business->logo) && !empty($business->logo) ? $logo . '/' . $business->logo : asset('custom/img/logo-placeholder-image-2.png') }}" id="business_logo_preview" alt="user" class="img-fluid">
                                        </div>
                                        <div class="vcard-description">
                                            <h1 id="{{ $stringid . '_title' }}_preview">{{ $business->title }}
                                            </h1>
                                            <h6 id="{{ $stringid . '_designation' }}_preview">
                                                {{ $business->designation }}</h6>
                                            <p id="{{ $stringid . '_subtitle' }}_preview">
                                                {{ $business->sub_title }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-contact pt-0">
                            <div
                                ...
                                <div class="make-an-appointment d-flex mr-2">
                                    <span class="w-100" tabindex="0" data-toggle="tooltip"
                                        ...
                                        <button type="button"
                                            ...
                                            <img src="{{ asset('custom/theme5/icon/save.svg') }}" alt="folder"
                                                class="img-fluid">
                                            <!-- <h4>{{ __('Save card') }}</h4> -->
                                        </button>
                                    </span>
                                ...
                                <div class="make-an-appointment d-flex mr-2">
                                    <span class="w-100" tabindex="0" data-toggle="tooltip"
                                        ...
                                        <button type="button"
                                            ...
                                            <img src="{{ asset('custom/theme5/icon/share.svg') }}" alt="signout"
                                                class="img-fluid">
                                ...
                                <div class="make-an-appointment d-flex mr-2">
                                    <span class="w-100" tabindex="0" data-toggle="tooltip"
                                        ...
                                        <button type="button"
                                            ...
                                            <img src="{{ asset('custom/theme5/icon/call.svg') }}" alt="folder"
                                                class="img-fluid">
                                            <!-- <h4>{{ __('Save card') }}</h4> -->
                                        </button>
                                    </span>
                                                        ...
                                                        @if ($social_key1 !== 'id')
                                                            <div class="col-3 socials_{{ $loop->parent->index + 1 }}"
                                                                ...
                                                                <div class="social-image-icon">
                                                                    <a href="{{ $social_val1 }}">
                                                                        <img src="{{ asset('custom/theme5/icon/' . $color . '/social/' . strtolower($social_key1) . '.svg') }}"
                        ...
                        @if ($j == $order_value)
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"
                                                        ...
                                                        <div class="service-card pb-3">
                                                            <div class="service-card-img">
                                                                {{-- <img src="{{ !empty($content->image) ? asset(Storage::url('service_images/' . $content->image)) : asset('custom/theme2/icon/image.svg') }}"
                                                                    ...
                                                                    <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="image-icon">
                                                                                <img src="{{ asset('custom/theme5/icon/' . $color . '/contact/' . strtolower($key1) . '.svg') }}"
                                                                                    alt="{{ $key1 }}"
                                                                                    class="img-fluid">
                                                                            </div>
                                                                            <div class="contact-text">
                            ...
                            @if ($order_key == 'more')
                                <div class="card-contact banner-card-header">
                                    <div
                                        class="text-center card-business-hours d-flex align-items-center justify-content-between p-0">
                                        <div class="make-an-appointment d-flex mr-2">
                                            <span class="w-100" tabindex="0" data-toggle="tooltip"
                                                title="{{ __('Save card') }}">
                                                <button type="button"
                                                    class="make-an-appointment-btn-main d-flex align-items-center justify-content-center w-100 save-card"
                                                    onclick="location.href = '{{ route('bussiness.save', $business->slug) }}'">
                                                    <img src="{{ asset('custom/theme5/icon/save.svg') }}"
                                        ...
                                        <div class="make-an-appointment d-flex  mr-2">
                                            <span class="w-100" tabindex="0" data-toggle="tooltip"
                                                ...
                                                <button type="button"
                                                    class="border-dark make-an-appointment-btn-main d-flex align-items-center justify-content-center w-100 bg-transparent"
                                                    data-toggle="modal" data-target="#myModal">
                                                    <img src="{{ asset('custom/theme5/icon/signout.svg') }}"
                                        ...
                                        <img src="{{ asset('custom/theme5/icon/call.svg') }}" alt="folder" class="img-fluid">
                                         <h4>{{ __('Save card') }}</h4>
                                    </button> -->
                                                <button type="button"
                                                    class="make-an-appointment-btn-main d-flex align-items-center justify-content-center w-100 save-card"
                                                    data-toggle="modal" data-target="#mycontactModal">
                                                    <img src="{{ asset('custom/theme5/icon/call.svg') }}"
                                                        alt="folder" class="img-fluid">
                                                    <!-- <h4>{{ __('Save card') }}</h4> -->
                                                </button>
                                            </span>
                ...
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        ...
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center"
                            data-dismiss="modal">
                            <img src="{{ asset('custom/theme5/icon/close.svg') }}" alt="back"
                                class="img-fluid">
                        </button>
                    </div>
                </div>
            ...
            <div class="modal-content">
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center"
                            data-dismiss="modal">
                            <img src="{{ asset('custom/theme5/img/back.svg') }}" alt="back"
                                class="img-fluid">
                        </button>
                        <h4 class="modal-title" style="color:black;">{{ __('Share this card') }}</h4>
                        <button type="button" class="logout-btn">
                            {{-- <img src="{{ asset('custom/theme5/icon/signout-black.svg') }}" alt="signout"
                                class="img-fluid"> --}}
                        </button>
                    </div>
                </div>
                    ...
                    <div class="modal-body-section text-center">
                        <div class="qr-main-image">
                            <div class="qr-code-border">
                                <img src="{{ asset('custom/theme5/icon/left-top.svg') }}" alt="left-top"
                                    class="img-fluid left-top-border">
                                <img src="{{ asset('custom/theme5/icon/left-bottom.svg') }}" alt="left-bottom"
                                    class="img-fluid left-bottom-border">
                                <img src="{{ asset('custom/theme5/icon/right-top.svg') }}" alt="right-top"
                                    class="img-fluid right-top-border">
                                <img src="{{ asset('custom/theme5/icon/right-bottom.svg') }}" alt="right-bottom"
                        ...
                        {{-- <div class="social-icon-section modal-social-icon-section">
                            <div class="text-center card-business-hours pb-20">
                                <div class="container-lg">
                                    <div class="row">
                                        <div
                                            class="social-icon w-100 d-flex align-items-center justify-content-center inputrow_socials_preview">
                                            @foreach ($social_content as $social_key => $social_val)
                                                @foreach ($social_val as $social_key1 => $social_val1)
                                                    @if ($social_key1 != 'id')
                                                        <span class="socials_{{ $loop->parent->index + 1 }}"
                                                            id="socials_{{ $loop->parent->index + 1 }}">
                                                            <div class="image-icon">
                                                                <a href="#">
                                                                    <img src="{{ asset('custom/theme5/icon/' . $color . '/social_white/' . strtolower($social_key1) . '.svg') }}"
                                                                        alt="twitter" class="img-fluid">
                                                                </a>
                                                            </div>
                                                        </span>
