...
<meta charset="UTF-8">
    ...
    <meta name="description" content="{{$business->meta_description}}">
     @if(isset($is_slug))
    <link rel="stylesheet" href="{{asset('custom/theme3/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('custom/theme3/modal/bootstrap.min.css')}}">
    <script src="{{asset('custom/theme3/modal/jquery.min.js')}}"></script>
    <script src="{{asset('custom/theme3/modal/bootstrap.min.js')}}"></script>
    <link rel="stylesheet" href="{{asset('custom/theme3/fontawesome-free/css/all.min.css')}}">
    <link rel="stylesheet" href="{{ asset('custom/css/emojionearea.min.css') }}">
    <link rel="stylesheet" href="{{asset('assets/css/plugins/animate.min.css')}}" />
    @endif
    <link rel="stylesheet" href="{{asset('custom/theme3/css/styles/'.$business->theme_color.'/style.css')}}">
    @if(isset($is_slug))
                                                            ...
                                                            @if($key1 != 'id')
                                                                <li class="d-flex align-items-center justify-content-start" id="contact_{{$loop->parent->index+1}}">
                                                                    <div class="image-icon">
                                                                        <img src="{{asset('custom/theme3/icon/contact/'.strtolower($key1).'.svg')}}" alt="{{$key1}}" class="img-fluid">
                                                                    </div>
                                            ...
                                            <div class="make-an-appointment d-flex">
                                                ...
                                                <div class="make-an-appointment-btn">
                                                    <button type="button" data-toggle="modal" data-target="#appointment-modal"
                                                        ...
                                                        <img src="{{asset('custom/theme3/icon/calender-black.svg')}}" alt="calender-black"
                                                            class="img-fluid">
                                        ...
                                        <div class="make-an-appointment d-flex mb-3">
                                            <div class="w-100">
                                                <button type="button"
                                                    ...
                                                    <img src="{{asset('custom/theme3/icon/save.svg')}}" alt="folder" class="img-fluid">
                                                    <h4>{{__('Save card')}}</h4>
                                                </button>
                                            </div>
                                        </div>
                                        <div class="make-an-appointment d-flex mb-3">
                                            <div class="w-100">
                                                <button type="button"
                                                    ...
                                                    <img src="{{asset('custom/theme3/icon/share.svg')}}" alt="signout" class="img-fluid">
                                        ...
                                        <div class="make-an-appointment d-flex mb-3">
                                            <div class="w-100">
                                                <button type="button"
                                                    ...
                                                    <img src="{{asset('custom/theme3/icon/Phone.svg')}}"  class="img-fluid">
                                                    <h4>{{__('Contact')}}</h4>
                                                </button>
                                            </div>
                                        </div>
                                                        ...
                                                        @foreach($social_val as $social_key1 => $social_val1)
                                                            ...
                                                            <div class="social-image-icon socials_{{$loop->parent->index+1}}" id="socials_{{$loop->parent->index+1}}">
                                                                <a href="{{$social_val1}}" id="social_link_{{$loop->parent->index+1}}_href_preview" class="social_link_{{$loop->parent->index+1}}_href_preview" target="_blank">
                                                                    <img src="{{asset('custom/theme3/icon/social/'.strtolower($social_key1).'.svg')}}" alt="{{$social_key1}}"
                                                                        class="img-fluid">
                                                                </a>
                                                            </div>
                                                            @endif
                ...
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        ...
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center"
                            data-dismiss="modal">
                            <img src="{{asset('custom/theme3/icon/close.svg')}}" alt="back" class="img-fluid">
                        </button>
                    </div>
                </div>
            ...
            <div class="modal-content">
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center"
                            data-dismiss="modal">
                            <img src="{{asset('custom/theme3/img/back.svg')}}" alt="back" class="img-fluid">
                        </button>
                        <h4 class="modal-title">{{__('Share this card')}}</h4>
                        <button type="button" class="logout-btn">
                            {{-- <img src="{{asset('custom/theme3/icon/signout.svg')}}" alt="signout" class="img-fluid"> --}}
                        </button>
                    </div>
                </div>
                    ...
                    <div class="modal-body-section text-center">
                        <div class="qr-main-image">
                            <div class="qr-code-border">
                                <img src="{{asset('custom/theme3/icon/left-top.svg')}}" alt="left-top" class="img-fluid left-top-border">
                                <img src="{{asset('custom/theme3/icon/left-bottom.svg')}}" alt="left-bottom"
                                    class="img-fluid left-bottom-border">
                                <img src="{{asset('custom/theme3/icon/right-top.svg')}}" alt="right-top" class="img-fluid right-top-border">
                                <img src="{{asset('custom/theme3/icon/right-bottom.svg')}}" alt="right-bottom"
                                            ...
                                            @foreach($social_val as $social_key1 => $social_val1)
                                                ...
                                                <span id="socials_{{$loop->parent->index+1}}" class="col-1 socials_{{$loop->parent->index+1}}">
                                                    <a href="{{url($social_val1)}}" class="social_link_{{$loop->parent->index+1}}_href_preview" id="social_link_{{$loop->parent->index+1}}_href_preview"  target="_blank">
                                                        <div class="image-icon">
                                                            <img src="{{asset('custom/theme3/icon/modal/'.strtolower($social_key1).'.svg')}}" alt="{{$social_key1}}" class="img-fluid">
                                                        </div>
                                                    </a>
                                                </span>
                                                @endif
