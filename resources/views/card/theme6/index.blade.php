...
<head>
    ...
    @if (isset($is_slug))
        <link rel="stylesheet" href="{{ asset('custom/theme6/css/bootstrap.min.css') }}">
        <link rel="stylesheet" href="{{ asset('custom/theme6/modal/bootstrap.min.css') }}">
        <script src="{{ asset('custom/theme6/modal/jquery.min.js') }}"></script>
        <script src="{{ asset('custom/theme6/modal/bootstrap.min.js') }}"></script>
        <link rel="stylesheet" href="{{ asset('custom/theme6/fontawesome-free/css/all.min.css') }}">
        <link rel="stylesheet" href="{{ asset('custom/css/emojionearea.min.css') }}">
        <link rel="stylesheet" href="{{asset('assets/css/plugins/animate.min.css')}}" />
    @endif
    <link rel="stylesheet" href="{{ asset('custom/theme6/css/styles/' . $business->theme_color . '/style.css') }}">
    @if (isset($is_slug))
                                                        ...
                                                        <div class="col-2">
                                                            <div class="image-icon">
                                                                <a href="{{ $social_val1 }}" target="_blank">
                                                                    <img src="{{ asset('custom/theme6/icon/' . $color . '/social/' . strtolower($social_key1) . '.svg') }}"
                                                ...
                                                <div class="row">
                                                    <div class="social-icon-main w-100 d-flex align-items-center justify-content-between "
                                                        ...
                                                        @foreach ($social_content as $social_key => $social_val)
                                                            @foreach ($social_val as $social_key1 => $social_val1)
                                                                @if ($social_key1 != 'id')
                                                                    <div class="social-image-icon socials_{{ $loop->parent->index + 1 }}"
                                ...
                                <div class="card-contact section-radius" id="appointment-div">
                                    <div class="">
                                        <ul>
                                            <li class="d-flex align-items-center justify-content-start">
                                                <div class="contact-text">
                                                    <h3 class="theme-text"> <span> {{ __('Make an') }} </span>
                                                        {{ __('appointment') }}</h3>
                                                </div>
                                            </li>
                                        </ul>
                                            ...
                                            <div class="make-an-appointment d-flex">
                                                ...
                                                <div class="make-an-appointment-btn">
                                                    <button type="button" data-toggle="modal"
                                                        ...
                                                        <img src="{{ asset('custom/theme6/icon/white/calender-white.svg') }}"
                                            ...
                                            <div class="make-an-appointment d-flex mb-3">
                                                <div class="w-100">
                                                    <button type="button"
                                                        ...
                                                        <img src="{{ asset('custom/theme6/icon/white/folder-white.svg') }}"
                                            ...
                                            <div class="make-an-appointment d-flex mb-3">
                                                <div class="w-100">
                                                    <button type="button"
                                                        ...
                                                        <img src="{{ asset('custom/theme6/icon/white/share-white.svg') }}"
                                            ...
                                            <div class="make-an-appointment d-flex mb-3">
                                                <div class="w-100">
                                                    <button type="button"
                                                        ...
                                                        <img src="{{ asset('custom/theme6/icon/white/Phone.svg') }}"
                                                            alt="share" class="img-fluid">
                                                        <h4>{{ __('Contact') }}</h4>
                                                    </button>
                                                </div>
                ...
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        ...
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center"
                            data-dismiss="modal">
                            <img src="{{ asset('custom/theme6/icon/close.svg') }}" alt="back"
                                class="img-fluid">
                        </button>
                    </div>
                </div>
            ...
            <div class="modal-content">
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center"
                            data-dismiss="modal">
                            <img src="{{ asset('custom/theme6/icon/back.svg') }}" alt="back"
                                class="img-fluid">
                        </button>
                        <h4 class="modal-title">{{ __('Share this card') }}</h4>
                        <button type="button" class="logout-btn">
                            {{-- <img src="{{ asset('custom/theme6/icon/white/share-white.svg') }}" alt="signout"
                                class="img-fluid"> --}}
                        </button>
                    </div>
                </div>
                                ...
                                <div class="container-lg">
                                    <div class="row justify-content-center">
                                        ...
                                        @foreach ($social_content as $social_key => $social_val)
                                            @foreach ($social_val as $social_key1 => $social_val1)
                                                @if ($social_key1 != 'id')
                                                    <div class="image-icon col-1 socials_{{ $loop->parent->index + 1 }}"
                                                        id="socials_{{ $loop->parent->index + 1 }}">
                                                        <a href="{{ $social_val1 }}" target="_blank">
                                                            <img src="{{ asset('custom/theme6/icon/' . $color . '/modal/' . strtolower($social_key1) . '.svg') }}"
