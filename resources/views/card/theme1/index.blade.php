                ...
                <div class="bg-white overflow-hidden">
                    <div class="banner-image">
                        <div class="banner-image-main">
                            ...
                            {{-- <img src="{{ !empty($business->banner) ? $banner . '/' . $business->banner : $banner . 'card_banner/' }}"   id="banner_preview" alt="fs"> --}}
                        </div>
                        <div class="media align-items-center justify-content-center profile-head">
                            <div class="profile">
                                ...
                                {{-- <img src="{{ !empty($business->logo) ? $logo . '/' . $business->logo : $logo . 'card_logo/' }}" id="business_logo_preview" alt="user" class="mb-4 img-thumbnail"> --}}
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="make-an-appointment d-flex mb-3">
                                            <div class="w-100">
                                                <button type="button"
                                                    ...
                                                    <h4><a class="text-black" href="{{ route('bussiness.save',$business->slug)}}">{{__('Save card')}}</a></h4>
                                                </button>
                                            </div>
                                        </div>
                                        <div class="make-an-appointment d-flex mb-3">
                                                ...
                                                <div class="col-lg-6 pr-8 pl-0 res-pr-0" id="testimonials_{{$testimonials_row_no}}">
                                                    <div class="service-card testimonials-card">
                                                        <div class="service-card-img ">
                                                            ...
                                                            <img id="{{'t_image'.$t_image_count.'_preview'}}" src="{{ !empty($testi_content->image) ? $image . '/' . $testi_content->image : $image . 'testimonials_images/' .$testi_content->image}}"alt="user" class="img-fluid">
                                                        </div>
                                                        <div class="service-card-heading">
                                                            <h3>
                ...
                <div class="modal-body px-4">
                    <form class="appointment-form">
                      ...
                      <div class="form-group">
                       ...
                       <input type="number" name="phone" placeholder="{{__('Enter your phone no.')}}" class="form-control app_phone" id="recipient-name">
                       <div class="">
