...
<head>
    ...
    @if (isset($is_slug))
        <link rel="stylesheet" href="{{ asset('custom/theme4/css/bootstrap.min.css') }}">
        <link rel="stylesheet" href="{{ asset('custom/theme4/modal/bootstrap.min.css') }}">
        <script src="{{ asset('custom/theme4/modal/jquery.min.js') }}"></script>
        <script src="{{ asset('custom/theme4/modal/bootstrap.min.js') }}"></script>
        <link rel="stylesheet" href="{{ asset('custom/theme4/fontawesome-free/css/all.min.css') }}">
        <link rel="stylesheet" href="{{ asset('custom/css/emojionearea.min.css') }}">
        <link rel="stylesheet" href="{{asset('assets/css/plugins/animate.min.css')}}" />
    @endif
    <link rel="stylesheet" href="{{ asset('custom/theme4/css/styles/' . $business->theme_color . '/style.css') }}">
    @if (isset($is_slug))
...
<body>
    <div class="wrapper">
        <div class="vCard" data-v-f2a183a6="" id="boxes">
            <div data-v-f2a183a6="" class="vCard-header">
                <div data-v-f2a183a6="" class="bg-white overflow-hidden">
                    <div data-v-f2a183a6="" class="banner-image">
                    ...
                    @foreach ($card_theme->order as $order_key => $order_value)
                        @if ($j == $order_value)
                                    ...
                                    <div
                                        ...
                                        <div class="make-an-appointment d-flex">
                                            <button type="button"
                                                ...
                                                title="{{ __('Save card') }}">
                                                <img src="{{ asset('custom/theme4/icon/save.svg') }}" alt="folder"
                                                    class="img-fluid">
                                                <!--  <h4></h4> -->
                                            </button>
                                        </div>
                                        <div class="make-an-appointment d-flex">
                                            <span class="w-100" tabindex="0" data-toggle="tooltip"
                                                ...
                                                <button type="button"
                                                    ...
                                                    data-original-title="{{ __('Share card') }}">
                                                    <img src="{{ asset('custom/theme4/icon/share.svg') }}"
                                        ...
                                        <div class="make-an-appointment d-flex">
                                            <span class="w-100" tabindex="0" data-toggle="tooltip"
                                                ...
                                                <button type="button"
                                                    ...
                                                    data-toggle="tooltip" data-original-title="{{ __('Contact') }}">
                                                    <img src="{{ asset('custom/theme4/icon/call.svg') }}"
                                            ...
                                            <!--  <button type="button"
                                                class="make-an-appointment-btn-main d-flex align-items-center justify-content-center w-100"  data-toggle="modal" data-target="#mycontactModal"  data-toggle="tooltip" data-original-title="{{ __('Contact') }}">
                                                <a data-toggle="tooltip" data-placement="top" title="Tooltip">
                                                    <img src="{{ asset('custom/theme4/icon/call.svg') }}" alt="folder" class="img-fluid">
                                                </a>
                                                <h4></h4>
                                            </button> -->
                                        </div>
                                                            ...
                                                            @if ($social_key1 !== 'id')
                                                                <div class="col-2 socials_{{ $loop->parent->index + 1 }}"
                                                                    ...
                                                                    <div class="social-image-icon">
                                                                        <a href="{{ $social_val1 }}"
                                                                            target="_blank">
                                                                            <img src="{{ asset('custom/theme4/icon/' . $color . '/social/' . strtolower($social_key1) . '.svg') }}"
                                                                                alt="{{ $social_key1 }}"
                                                                                class="img-fluid">
                                                                        </a>
                                                                    </div>
                            ...
                            @if ($order_key == 'appointment')
                                <div class="card-contact " id="appointment-div">
                                                ...
                                                <div class="col-lg-6" id="services_{{$service_row_no}}">
                                                    <div class="service-card pb-3">
                                                        ...
                                                        <div class="service-card-heading">
                                                            ...
                                                            <p style="color:white" id="{{'description_'.$service_row_no.'_preview'}}">
                                                                {{$content->description}}
                                                            </p>
                            ...
                            @if ($order_key == 'testimonials')
                                <div id="testimonials-div">
                                    <div class="card-detail card-business-date mb-2">
                                        <ul>
                                            <li class="d-flex align-items-center justify-content-center">
                                                <div class="contact-text">
                                            ...
                                            @foreach ($testimonials_content as $k2 => $testi_content)
                                                <div class="col-lg-6 pr-8 pl-0 res-pr-0"id="testimonials_{{ $testimonials_row_no }}">
                                                    <div class="service-card testimonials-card ">
                                                        ...
                                                        <div class="service-card-heading ">
                                                            <h3>
                                                                <span class="stars{{ $testimonials_row_no }} text-black">{{ $testi_content->rating }}/5</span>
                                                            </h3>
                                                            @php
                                                            ...
                                                            @endphp
                                                            <div class="star-section d-flex align-items-center justify-content-center" id="stars{{ $testimonials_row_no}}_star">
                                                                @for ($i = 1; $i <= 5; $i++)
                                                                    @if ($overallrating < $i)
                                                            ...
                                                            <p id="testimonial_description_{{ $testimonials_row_no.'_preview' }}" class="text-black">
                            ...
                            @if ($order_key == 'contact_info')
                                @if (isset($contactinfo['is_enabled']) && $contactinfo['is_enabled'] == '1')
                                    <div class="card-contact" id="showContact_preview">
                                        <div class="card-contact-header">
                                            <ul>
                                                <li class="d-flex align-items-center justify-content-center">
                                                    <div class="contact-text">
                                                                    ...
                                                                    @if ($key1 != 'id')
                                                                        <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center"
                                                                            ...
                                                                            <div class="image-icon">
                                                                                <img src="{{ asset('custom/theme4/icon/' . $color . '/contact/' . strtolower($key1) . '.svg') }}"
                                                                                    alt="{{ $key1 }}"
                                                                                    class="img-fluid">
                                                                            </div>
                                                                            <div class="contact-text">
                ...
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        ...
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center"
                            data-dismiss="modal">
                            <img src="{{ asset('custom/theme4/icon/close.svg') }}" alt="back" class="img-fluid">
                        </button>
                    </div>
                </div>
            ...
            <div class="modal-content">
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center"
                            data-dismiss="modal">
                            <img src="{{ asset('custom/theme4/img/back.svg') }}" alt="back" class="img-fluid">
                        </button>
                        <h4 class="modal-title">{{ __('Share this card') }}</h4>
                        <button type="button" class="logout-btn">
                            {{-- <img src="{{ asset('custom/theme4/icon/signout.svg') }}" alt="signout"
                                class="img-fluid"> --}}
                        </button>
                    </div>
                </div>
                    ...
                    <div class="modal-body-section text-center">
                        <div class="qr-main-image">
                            <div class="qr-code-border">
                                <img src="{{ asset('custom/theme4/icon/left-top.svg') }}" alt="left-top"
                                    class="img-fluid left-top-border">
                                <img src="{{ asset('custom/theme4/icon/left-bottom.svg') }}" alt="left-bottom"
                                    class="img-fluid left-bottom-border">
                                <img src="{{ asset('custom/theme4/icon/right-top.svg') }}" alt="right-top"
                                    class="img-fluid right-top-border">
                                <img src="{{ asset('custom/theme4/icon/right-bottom.svg') }}" alt="right-bottom"
                                ...
                                <div class="container-lg">
                                    <div class="row justify-content-center">
                                        @foreach ($social_content as $social_key => $social_val)
                                            @foreach ($social_val as $social_key1 => $social_val1)
                                                @if ($social_key1 !== 'id')
                                                    <div class="col-1 socials_{{ $loop->parent->index + 1 }}"
                                                        id="socials_{{ $loop->parent->index + 1 }}">
                                                        <div class="image-icon">
                                                            <a href="{{ $social_val1 }}">
                                                                <img src="{{ asset('custom/theme4/icon/' . $color . '/contact/' . strtolower($social_key1) . '.svg') }}"
                ...
                <div class="modal-body px-4">
                    <form action="{{ route('contacts.store') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="message" placeholder="Enter your Message." class="form-control emojiarea" id="recipient-name"></textarea>
                        </div>
