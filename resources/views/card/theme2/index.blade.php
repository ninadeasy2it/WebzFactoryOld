...
<meta charset="UTF-8">
    ...
    @if(isset($is_slug))
    <link rel="stylesheet" href="{{asset('custom/theme2/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('custom/theme2/modal/bootstrap.min.css')}}">
    <script src="{{asset('custom/theme2/modal/jquery.min.js')}}"></script>
    <script src="{{asset('custom/theme2/modal/bootstrap.min.js')}}"></script>
    <link rel="stylesheet" href="{{asset('custom/theme2/fontawesome-free/css/all.min.css')}}">
    <link rel="stylesheet" href="{{ asset('custom/css/emojionearea.min.css') }}">
    <link rel="stylesheet" href="{{asset('assets/css/plugins/animate.min.css')}}" />
    @endif
    <link rel="stylesheet" href="{{asset('custom/theme2/css/styles/'.$business->theme_color.'/style.css')}}">
    @if(isset($is_slug))
                ...
                <div class="bg-white overflow-hidden">
                    <div class="banner-image">
                        <div class="banner-image-main">
                            ...
                            <img src="{{ isset($business->banner) && !empty($business->banner) ? $banner . '/' . $business->banner  : asset('custom/img/placeholder-image.jpg') }}" id="banner_preview" alt="fs">
                        </div>
                        <div class="media align-items-center justify-content-center profile-head">
                            <div class="profile">
                                ...
                                <img src="{{ isset($business->logo) && !empty($business->logo) ? $logo . '/' . $business->logo : asset('custom/img/logo-placeholder-image-2.png') }}" id="business_logo_preview" alt="user" class="mb-4 img-thumbnail">
                            </div>
                        </div>
                    </div>
                                                            ...
                                                            @if($key1 != 'id')
                                                                <li class="d-flex align-items-center justify-content-start" id="contact_{{$loop->parent->index+1}}">
                                                                    <div class="image-icon">
                                                                        <img src="{{asset('custom/theme2/icon/'.$color.'/contact/'.strtolower($key1).'.svg')}}" alt="{{$key1}}" class="img-fluid">
                                                                    </div>
                                        ...
                                        <div class="">
                                            <ul>
                                                <li class="d-flex align-items-center justify-content-start">
                                                    <div class="image-icon">
                                                        <img src="{{asset('custom/theme2/icon/'.$color.'/clock.svg')}}" alt="clock" class="img-fluid">
                                                    </div>
                                                    <div class="contact-text">
                                    ...
                                    <div class="card-contact">
                                        <div class="">
                                            <ul>
                                                <li class="d-flex align-items-center justify-content-start">
                                                    <div class="image-icon">
                                                        <img src="{{asset('custom/theme2/icon/'.$color.'/calender.svg')}}" alt="calendar" class="img-fluid">
                                                    </div>
                                                    <div class="contact-text">
                                                ...
                                                <div class="make-an-appointment d-flex">
                                                    ...
                                                    <div class="make-an-appointment-btn">
                                                        <button type="button" data-toggle="modal" data-target="#appointment-modal"
                                                            ...
                                                            <img src="{{asset('custom/theme2/icon/'.$color.'/calender-black.svg')}}" alt="calender-black"
                                                                class="img-fluid">
                                    ...
                                    <div class="card-contact">
                                        <div class="">
                                            <ul>
                                                <li class="d-flex align-items-center justify-content-start">
                                                    <div class="image-icon">
                                                        <img src="{{asset('custom/theme2/icon/'.$color.'/call2.svg')}}" alt="call2" class="img-fluid">
                                                    </div>
                                                    <div class="contact-text">
                                                        ...
                                                        <div class="col-lg-6" id="services_{{$service_row_no}}">
                                                            <div class="service-card pb-3">
                                                                <div class="service-card-img testimonials_image">
                                                                    {{-- <img id="{{'s_image'.$image_count.'_preview'}}"  src="{{ !empty($content->image) ? asset(Storage::url('service_images/'.$content->image)) : asset('custom/theme2/icon/image.svg') }}" alt="image" class="img-fluid"> --}}
                                ...
                                <div class="card-contact">
                                    <div class="">
                                        <ul>
                                            <li class="d-flex align-items-center justify-content-start">
                                                <div class="image-icon">
                                                    <img src="{{asset('custom/theme2/icon/'.$color.'/more.svg')}}" alt="bookmark" class="img-fluid">
                                                </div>
                                                <div class="contact-text">
                                        ...
                                        <div class="make-an-appointment d-flex mb-3">
                                            <div class="w-100">
                                                <button type="button"
                                                    ...
                                                    <img src="{{asset('custom/theme2/icon/'.$color.'/save.svg')}}" alt="folder" class="img-fluid">
                                                    <h4>{{__('Save card')}}</h4>
                                                </button>
                                            </div>
                                        </div>
                                        <div class="make-an-appointment d-flex mb-3">
                                            <div class="w-100">
                                                <button type="button"
                                                    ...
                                                    <img src="{{asset('custom/theme2/icon/'.$color.'/share.svg')}}" alt="signout" class="img-fluid">
                                        ...
                                        <div class="make-an-appointment d-flex mb-3">
                                            <div class="w-100">
                                                <button type="button"
                                                    ...
                                                    <img src="{{asset('custom/icon/phone.svg')}}" alt="signout" class="img-fluid">
                                                    <h4>{{__('Contact')}}</h4>
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-contact">
                                        <div class="">
                                            <ul>
                                                <li class="d-flex align-items-center justify-content-start">
                                                    <div class="image-icon">
                                                        <img src="{{asset('custom/theme2/icon/'.$color.'/social.svg')}}" alt="bookmark" class="img-fluid">
                                                    </div>
                                                    <div class="contact-text">
                                                                    ...
                                                                    @if($social_key1 != 'id')
                                                                        <div class="col-3 social-image-icon mb-3 socials_{{$loop->parent->index+1}}" id="socials_{{$loop->parent->index+1}}">
                                                                            <a href="{{url($social_val1)}}" class="social_link_{{$loop->parent->index+1}}_href_preview" id="social_link_{{$loop->parent->index+1}}_href_preview'}}"  target="_blank">
                                                                                <img src="{{asset('custom/theme2/icon/'.$color.'/social/'.strtolower($social_key1).'.svg')}}" alt="{{$social_key1}}"
                                                                                    class="img-fluid hover-hide">
                                                                                <img src="{{asset('custom/theme2/icon/'.$color.'/social_white/'.strtolower($social_key1).'.svg')}}" alt="{{$social_key1}}"
                        ...
                        @endif
                        {{-- <div class="text-center">
                            <h6 id="{{$stringid.'_branding'}}_preview">{{$business->branding_text}}</h6>
                        </div>  --}}
                        @if(isset($is_slug))
                            @if($is_gdpr_enabled)
                                {{-- {{ $gdpr_text }} --}}                            
                ...
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        ...
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center"
                            data-dismiss="modal">
                            <img src="{{asset('custom/theme2/icon/close.svg')}}" alt="back" class="img-fluid">
                        </button>
                    </div>
                </div>
            ...
            <div class="modal-content">
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center"
                            data-dismiss="modal">
                            <img src="{{asset('custom/theme2/img/back.svg')}}" alt="back" class="img-fluid">
                        </button>
                        <h4 class="modal-title">{{__('Share this card')}}</h4>
                        <button type="button" class="logout-btn">
                            {{-- <img src="{{asset('custom/theme2/icon/black/signout.svg')}}" alt="signout" class="img-fluid"> --}}
                        </button>
                    </div>
                </div>
                    ...
                    <div class="modal-body-section text-center">
                        <div class="qr-main-image">
                            <div class="qr-code-border">
                                <img src="{{asset('custom/theme2/icon/left-top.svg')}}" alt="left-top" class="img-fluid left-top-border">
                                <img src="{{asset('custom/theme2/icon/left-bottom.svg')}}" alt="left-bottom"
                                    class="img-fluid left-bottom-border">
                                <img src="{{asset('custom/theme2/icon/right-top.svg')}}" alt="right-top" class="img-fluid right-top-border">
                                <img src="{{asset('custom/theme2/icon/right-bottom.svg')}}" alt="right-bottom"
                                        ...
                                        @foreach($social_content as $social_key => $social_val)
                                            ...
                                            <span >
                                                <a href="{{url($social_val1)}}" class="{{'social_link_'.$social_no.'_href_preview'}}" id="{{'social_link_'.$social_no.'_href_preview'}}"  target="_blank">
                                                    <div class="image-icon">
                                                        <img src="{{asset('custom/theme2/icon/'.$color.'/modal/'.strtolower($social_key1).'.svg')}}" alt="{{$social_key1}}" class="img-fluid">
                                                    </div>
                                                </a>
                                            </span>  
                                            </div>  
