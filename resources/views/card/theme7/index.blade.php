...
<head>
    ...
    @if (isset($is_slug))
        ...
        <link rel="stylesheet" href="{{ asset('custom/theme7/fontawesome-free/css/all.min.css') }}">
        <link rel="stylesheet" href="{{ asset('custom/css/emojionearea.min.css') }}">
        <link rel="stylesheet" href="{{asset('assets/css/plugins/animate.min.css')}}" />
    @endif
    <link rel="stylesheet" href="{{ asset('custom/theme7/css/styles/' . $business->theme_color . '/style.css') }}">
    @if (isset($is_slug))
                ...
                <div class="bg-white overflow-hidden">
                    ...
                    <div class="card-detail">
                        <div class="vcard-description">
                            ...
                            <p id="{{ $stringid . '_subtitle' }}_preview" style="color:#9D9D9D;">{{ $business->sub_title }}</p>
                        </div>
                        @php $j = 1; @endphp
                                                                    ...
                                                                    @if ($key1 != 'id')
                                                                        <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center"
                                                                            ...
                                                                            <div class="image-icon">
                                                                                <img src="{{ asset('custom/theme7/icon/' . $color . '/contact/' . strtolower($key1) . '.svg') }}"
                                                                                    alt="{{ $key1 }}"
                                                                                    class="img-fluid">
                                                                            </div>
                                            ...
                                            <div class="make-an-appointment d-flex">
                                                <span class="w-100" tabindex="0" data-toggle="tooltip"
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        <img src="{{ asset('custom/theme7/icon/save.svg') }}"
                                            ...
                                            <div class="make-an-appointment d-flex">
                                                <span class="w-100" tabindex="0" data-toggle="tooltip"
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        <img src="{{ asset('custom/theme7/icon/share.svg') }}"
                                            ...
                                            <div class="make-an-appointment d-flex">
                                                <span class="w-100" tabindex="0" data-toggle="tooltip"
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        <img src="{{ asset('custom/theme7/icon/white/Phone.svg') }}"
                                                            alt="folder" class="img-fluid">
                                                        <!-- s -->
                                                    </button>
                                                </span>
                                                    ...
                                                    @foreach ($services_content as $k1 => $content)
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"
                                                            ...
                                                            <div class="service-card card-contact-shadow mb-0 mt-3">
                                                                <div class="service-card-img">
                                                                    {{-- <img src="{{ !empty($content->image) ? asset(Storage::url('service_images/' . $content->image)) : asset('custom/theme7/icon/image.svg') }}"
                                                                ...
                                                                <div class="service-card-heading">
                                                                    ...
                                                                    <div class="card-footer justify-content-center pb-0">
                                                                        <a href="{{url($content->purchase_link)}}" class="text-black text-lg" target="_blank">
                                                                ...
                                                                @if ($social_key1 != 'id')
                                                                    <div class="col-2 socials_{{ $loop->parent->index + 1 }}"
                                                                        ...
                                                                        <div class="social-image-icon">
                                                                            <a href="{{ $social_val1 }}"
                                                                                target="_blank">
                                                                                <img src="{{ asset('custom/theme7/icon/' . $color . '/social/' . strtolower($social_key1) . '.svg') }}"
                                                                                    alt="{{ $social_key1 }}"
                                                                                    class="img-fluid">
                                                                            </a>
                                                                        </div>
            ...
            <div class="modal-content">
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center"
                            data-dismiss="modal">
                            <img src="{{ asset('custom/theme7/img/back.svg') }}" alt="back" class="img-fluid">
                        </button>
                        <h4 class="modal-title">{{ __('Share this card') }}</h4>
                        <button type="button" class="logout-btn">
                            {{-- <img src="{{ asset('custom/theme7/icon/share.svg') }}" alt="signout" class="img-fluid"> --}}
                        </button>
                    </div>
                </div>
                    ...
                    <div class="modal-body-section text-center">
                        <div class="qr-main-image">
                            <div class="qr-code-border">
                                <img src="{{ asset('custom/theme7/icon/left-top.svg') }}" alt="left-top"
                                    class="img-fluid left-top-border">
                                <img src="{{ asset('custom/theme7/icon/left-bottom.svg') }}" alt="left-bottom"
                                    class="img-fluid left-bottom-border">
                                <img src="{{ asset('custom/theme7/icon/right-top.svg') }}" alt="right-top"
                                    class="img-fluid right-top-border">
                                <img src="{{ asset('custom/theme7/icon/right-bottom.svg') }}" alt="right-bottom"
                                                        ...
                                                        <div class="col-2 socials_{{ $loop->parent->index + 1 }}"
                                                            ...
                                                            <div class="image-icon">
                                                                <a href="{{ $social_val1 }}" target="_blank">
                                                                    <img src="{{ asset('custom/theme7/icon/' . $color . '/modal/' . strtolower($social_key1) . '.svg') }}"
