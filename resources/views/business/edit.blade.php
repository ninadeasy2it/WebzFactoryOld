...
@section('breadcrumb')
    <li class="breadcrumb-item active" aria-current="page">
        <a href="{{ route('business.index') }}">{{ __('Business') }}</a>
    </li>
...
@section('action-btn')
    <a href="{{ route('get.card', $business->slug) }}" class="btn btn-sm btn-primary btn-icon" data-bs-toggle="tooltip"
        data-bs-original-title="{{ __('Download') }}" title="{{ __('Download') }}" target="_blanks">
        <span class="text-white">
            <i class="ti ti-printer"></i>
        </span>
    </a>
    {{-- <a class="btn btn-sm btn-primary btn-icon m-4 ml-0" id="download-qr"  title="QR CODE"><i class="fa fa-qrcode"></i></a> --}}
    <a  class="btn btn-sm btn-primary btn-icon" data-bs-toggle="tooltip" id="download-qr"
        data-bs-original-title="{{ __('Qr Code') }}" title="{{ __('Qr Code') }}" target="_blanks">
        <span class="text-white"><i class="fa fa-qrcode"></i></span>
    </a>
    {{-- <a class="btn btn-sm btn-primary btn-icon" data-bs-toggle="tooltip" data-toggle="modal" data-target="#myModal"
        data-bs-original-title="{{ __('Download') }}" title="{{ __('Download') }}" target="_blanks">
        <span class="text-white">
            ...
            <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="card bg-none card-box">
                                ...
                                <div class=" card-footer">
                                    <div class="col-12 d-flex justify-content-end ">
                                        ...
                                        <button type="submit"
                                            class="btn  btn-primary btn-lg float-end">{{ __('Save changes') }}</button><br>
                                    </div>
                                </div>
                                {{ Form::close() }}
                            </div>
                        ...
                        <div class="col-lg-7">
                            <div class="card">
                                <div class="card-header">
                                    <h5>{{ __('Edit Business Details') }}</h5>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div id="holder" style="max-height:100px;">
                                                ...
                                                <img src="{{ isset($business->banner_new) && !empty($business->banner_new) ? $banner_new . '/' . $business->banner_new : asset('custom/img/placeholder-image.jpg') }}"
                                                    class="imagepreview" id="banner">
                                                {{-- <img src="{{ !empty($business->banner_new) ? $banner_new . '/' . $business->banner_new : $banner_new   }}"  class="imagepreview" id="banner" > --}}
                                        ...
                                        <div class="row mt-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="file-1">
                                                        <button type="button" class="btn  btn-primary btn-lg"
                                                            onclick="selectFile('banner')">{{ __('Banner') }}</button>
                                                    </label>
                                                    @error('banner')
                                                        <span class="invalid-favicon text-xs text-danger"
                                                            role="alert">{{ $message }}</span>
                                            ...
                                            <div class="col-md-6">
                                                <img src="{{ isset($business->banner) && !empty($business->banner) ? $banner . '/' . $business->banner : asset('custom/img/placeholder-image.jpg') }}"
                                                    class="imagepreview" id="banner">
                                                    {{-- <img src="{{ !empty($business->banner) ? $banner . '/' . $business->banner : $banner . 'card_banner/' }}"  class="imagepreview" id="banner" > --}}
                                            </div>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <label for="file-1">
                                                        <button type="button" class="btn  btn-primary btn-lg"
                                                            onclick="selectFile('business_logo')">{{ __('Logo') }}</button>
                                                        <input type="hidden" name="business_id"
                                                            value="{{ $business->id }}">
                                                    </label>
                                                    @error('logo')
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                {{ Form::text('sub_title', $business->sub_title, ['class' => 'form-control ', 'id' => $stringid . '_subtitle', 'placeholder' => __('Enter Sub Title')]) }}
                                                @error('sub_title')
                                                    <span class="invalid-favicon text-xs text-danger"
                                                        role="alert">{{ $message }}</span>
                                                @enderror
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                {{ Form::textarea('description', $business->description, ['class' => 'form-control description-text ','rows' => '3', 'id' => $stringid . '_desc', 'placeholder' => __('Enter Description')]) }}
                                                @error('description')
                                                    <span class="invalid-favicon text-xs text-danger"
                                                        role="alert">{{ $message }}</span>
                                                @enderror
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-12">
                                            <div class="form-group">
                                                {{ Form::label('Occupation Category', __('Occupation Category'), ['class' => 'form-label']) }}
                                                    ...
                                                    <select name="category_id" id="category_id" class="form-control" onchange="get_business_Subcategory(this.value);" placeholder="Select a Occupation Category" readonly>
                                                        ...
                                                        @foreach(\App\Models\Utility::get_business_category() as $business_category)
                                                            <option @if($business->category_id == $business_category->category_id) selected @endif value="{{$business_category->category_id }}">{{Str::upper($business_category->name)}}</option>
                                                        @endforeach
                                                    </select>
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-12">
                                            <div class="form-group">
                                                {{ Form::label('Occupation Subcategory', __('Occupation Subcategory'), ['class' => 'form-label']) }}
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-12">
                                            <div class="form-group">
                                                {{ Form::label('slug', __('Personalized Link'), ['class' => 'form-label']) }}
                                                <div class="input-group">
                                                  ...
                                                  {{ Form::text('slug', $business->slug, ['class' => 'form-control', 'placeholder' => __('Enter Slug')]) }}
                                                </div>
                                                @error('slug')
                                                    <span class="invalid-favicon text-xs text-danger"
                                                        role="alert">{{ $message }}</span>
                                                                                            ...
                                                                                            <td class="text-right">
                                                                                                <div
                                                                                                    ...
                                                                                                    <button
                                                                                                        ...
                                                                                                        data-id="contact_{{ $loop->parent->index + 1 }}"><i
                                            ...
                                            <div class="accordion-item card">
                                                <h2 class="accordion-header" id="headingTwo">
                                                    <button class="accordion-button collapsed" type="button"
                                                        ...
                                                        <span class="d-flex align-items-center">
                                                            <i
                                                                class="ti ti-info-circle text-primary"></i>{{ __('Business Hours') }}
                                                        </span>
                                                    </button>
                                                </h2>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-6">
                                                                                    ...
                                                                                    <input type="time"
                                                                                        ...
                                                                                        name="start-{{ $k }}"
                                                                                        value="{{ !is_null($business_hours) && isset($business_hours->$k) && $business_hours->$k->days == 'on' ? $business_hours->$k->start_time : '' }}"
                                                                                        onchange="changeFunction(this.id)">
                                                                                </div>

                                                                                <div class="col-6">
                                                                                    {{-- <label for="inputValue" class="control-label">{{ __('End Time') }}</label> --}}
                                                                                    <input type="time"
                                                                                        id="days_{{ $k }}_end"
                                                                                        data-id="days_{{ $k }}"
                                                                                        class="form-control timepicker"
                                                                                                ...
                                                                                                <td class="text-right">
                                                                                                    <div
                                                                                                        ...
                                                                                                        <a class="btn btn-sm d-inline-flex align-items-center"
                                                                                                            ...
                                                                                                            data-id="{{ 'appointment_' . $appointment_no }}"><i
                                                                                    ...
                                                                                    <div class="card-body text-center">
                                                                                        <div
                                                                                            ...
                                                                                            <a class="btn btn-sm d-inline-flex align-items-center hover-none"
                                                                                                ...
                                                                                                data-id="{{ 'services_' . $service_row_no }}"><i
                                                                                                    class="ti ti-trash"></i></a>
                                                                                        </div>
                                                                                        <div
                                                                                            class="position-relative ml-2 d-inline-flex ">
                                                                                            {{-- <img alt="Image placeholder"
                                                                                                src="{{ !empty($content->image) ? asset(Storage::url('service_images/' . $content->image)) : asset('custom/img/placeholder-image.jpg') }}"
                                                                                                id="{{ 's_image' . $image_count }}"
                                                                                                class="imagepreview"> --}}

                                                                                                <img alt="Image placeholder"
                                                                                                        src="{{ !empty($content->image) ? $s_image . '/' . $content->image : $s_image . 'service_images/' }}"
                                                                                                        id="{{ 's_image' . $image_count}}"
                                                                                                        class="imagepreview">
                                                                                            <div
                                                                                                ...
                                                                                                <input type="file"
                                                                                                    id="file-1"
                                                                                                    class="custom-input-file custom-input-file-link s_image{{ $image_count }} d-none"
                                                                                                    data-multiple-caption="{count} files selected"
                                                                                                    multiple=""
                                                                                                ...
                                                                                                <input type="hidden"
                                                                                                    ...
                                                                                                    value="{{ $content->image }}">
                                                                                                <span
                                                                                                    class="btn btn-sm btn-info btn-icon" data-bs-toggle="tooltip" title="{{__('Edit')}}"
                                                                                                    onclick="selectFile('s_image{{ $image_count }}')"><i
                                                                                                        class="ti ti-pencil"
                                                                                                        onclick="selectFile('s_image{{ $image_count }}')"></i>
                                                                                                </span>
                                                                                            </div>
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <textarea class="border-0 textboxhover input-text-location text-center"
                                                                                                name="{{ 'services[' . $service_row_no . '][description]' }}" id="{{ 'description_' . $service_row_no }}"
                                                                                        ...
                                                                                        <div
                                                                                            class="mt-2 text-dark textarea-adjust">
                                                                                            <textarea class="border-0 textboxhover input-text-location text-center"
                                                                                                name="{{ 'services[' . $service_row_no . '][link_title]' }}" id="{{ 'link_title_' . $service_row_no }}"
                                                                                                placeholder="Enter link title">{{ $content->link_title }}</textarea>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="custom-control custom-switch">
                                                                            ...
                                                                            <input type="checkbox"
                                                                                ...
                                                                                {{ isset($testimonials['is_enabled']) && $testimonials['is_enabled'] == '1' ? 'checked="checked"' : '' }}>
                                                                        </div>
                                                                        <div class="col-auto justify-content-end">
                                                                            <button href="javascript:void(0)"
                                                                                class="btn btn-sm btn-primary btn-icon m-1"
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <a class="btn btn-sm d-inline-flex align-items-center hover-none"
                                                                                                        ...
                                                                                                        data-id="{{ 'testimonials_' . $testimonials_row_no }}"><i
                                                                                                            class="ti ti-trash"></i></a>
                                                                                                </div>
                                                                                                <div
                                                                                                    class="position-relative ml-2 d-inline-flex">
                                                                                                    <img alt="Image placeholder"
                                                                                                        src="{{ !empty($testi_content->image) ? $image . '/' . $testi_content->image : $image . 'testimonials_images/' }}"
                                                                                                        id="{{ 't_image' . $t_image_count }}"
                                                                                                        class="imagepreview">

                                                                                                        {{-- <img alt="Image placeholder" src="{{ !empty($testi_content->image) ? $image . '/' . $$testi_content->image : $image . 'testimonials_images/' }}"  id="{{ 't_image' . $t_image_count }}"
                                                                                                        class="imagepreview"> --}}
                                                                                                    <div
                                                                                                        class="position-absolute top-50 start-100 translate-middle">
                                                                                                        <input
                                                                                                            type="file"
                                                                                                            id="file-1"
                                                                                                            class="custom-input-file d-none custom-input-file-link t_image{{ $t_image_count }}"
                                                                                                            data-multiple-caption="{count} files selected"
                                                                                                            multiple=""
                                                                                                            name="{{ 'testimonials[' . $testimonials_row_no . '][image]' }}">
                                                                                                        <input
                                                                                                            type="hidden"
                                                                                                            name="{{ 'testimonials[' . $t_image_count . '][get_image]' }}"
                                                                                                            value="{{ $testi_content->image }}">
                                                                                                        <span
                                                                                                            class="btn btn-sm btn-info btn-icon" data-bs-toggle="tooltip" title="{{__('Edit')}}"
                                                                                                            onclick="selectFile('t_image{{ $t_image_count }}')">
                                                                                                            <i
                                                                                                                class="fas fa-pen"></i>
                                                                                                        </span>
                                                                                                    </div>
                                                                                                ...
                                                                                                <div class="mt-4 text-dark textarea-adjust">
                                                                                                    <textarea class="border-0 textboxhover input-text-location ml-46px" id="{{ 'testimonial_description_' . $testimonials_row_no }}"
                                                                                                        name="{{ 'testimonials[' . $testimonials_row_no . '][description]' }}"
                                                                                                        placeholder="Enter Description">{{ $testi_content->description }}</textarea>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                        ...
                                                                                        <td>
                                                                                            <div class="input-group">
                                                                                                <span
                                                                                                    ...
                                                                                                    <img
                                                                                                        src="{{ asset('custom/icon/black/' . strtolower($social_key1) . '.svg') }}">
                                                                                                </span>
                                                                                                <input type="text"
                                                                                                ...
                                                                                                <h6 class="text-danger text-xs"
                                                                                                    id="{{ 'social_link_' . $social_no . '_error_href' }}">
                                                                                                </h6>
                                                                                            </div>
                                                                                        </td>
                                                                                        <td class="text-right float-end">
                                                                                            <div
                                                                                                ...
                                                                                                <button
                                                                                                    ...
                                                                                                    data-id="socials_{{ $loop->parent->index + 1 }}"><i
                                                                                                        class="ti ti-trash text-white"></i></button>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                    ...
                                                    <div class="accordion-body">
                                                        ...
                                                        <div id="">
                                                            <div class="form-group custom_html_text mt-3">
                                                                <textarea id={{ $stringid }}_chtml type="text" name="custom_html_text" class="form-control emojiarea" rows="4"
                                                                    style="height: auto">{{ isset($customhtml['custom_html_text']) && $customhtml['custom_html_text'] ? $customhtml['custom_html_text'] : '' }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="tab-pane fade <?php if($fromTab=='domain-setting'){echo 'active show';} ?>" id="domain-setting" role="tabpanel" aria-labelledby="pills-user-tab-3">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="">
                                        <h5 class="mt-3 mb-4">{{ __('Custom Domain') }}</h5>
                                            ...
                                            <div class="col-12 pt-2 pb-4 px-0 custom-domain">
                                                <div class="btn-group btn-group-toggle" data-bs-toggle="buttons">
                                                    <label for="enable_storelink"
                                                        class="btn btn-primary mr-2 tab_btn {{ $business->enable_businesslink == 'on' ? 'active' : '' }}">
                                                        <input type="radio" class="domain_click d-none"
                                                            name="enable_domain" value="enable_businesslink"
                                                            id="enable_storelink"
                                                            {{ $business->enable_businesslink == 'on' ? 'checked' : '' }}">
                                                        {{ __('Business Link') }}
                                                    </label>
                                                    @if ($plan->enable_custdomain == 'on')
                                                        <label for="enable_domain"
                                                            class="btn btn-primary mr-2 tab_btn {{ $business->enable_domain == 'on' ? 'active' : '' }}">
                                                            <input type="radio" class="domain_click d-none"
                                                                name="enable_domain" value="enable_domain"
                                                                id="enable_domain"
                                                                {{ $business->enable_domain == 'on' ? 'checked' : '' }}>
                                                            {{ __('Domain') }}
                                                        </label>
                                                    @endif
                                                    @if ($plan->enable_custsubdomain == 'on')
                                                        <label for="enable_subdomain"
                                                            class="btn domain_click btn-primary mr-2 tab_btn {{ $business->enable_subdomain == 'on' ? 'active' : '' }}">
                                                            <input type="radio" class="domain_click d-none"
                                                                name="enable_domain" value="enable_subdomain"
                                                                id="enable_subdomain"
                                                                {{ $business->enable_subdomain == 'on' ? 'checked' : '' }}>
                                                            {{ __('Sub Domain') }}
                                                        </label>
                                                    @endif
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12 " id="StoreLink"
                                            style="{{ $business->enable_businesslink == 'on' ? 'display: block' : 'display: none' }}">
                                            {{ Form::label('business_link', __('Business Link'), ['class' => 'form-label']) }}
                                            <div class="input-group">
                                                <input type="text" value="{{ $business_url }}" id="myInput"
                                    ...
                                    @else
                                        <div class="form-group col-md-12" id="StoreLink">
                                            {{ Form::label('business_link', __('Business Link'), ['class' => 'form-control-label']) }}
                                            <div class="input-group">
                                                <input type="text" value="{{ $business_url }}" id="myInput"
                                                    class="form-control d-inline-block" aria-label="Recipient's username"
                                                    aria-describedby="button-addon2" readonly>
                        ...
                        <div class="col-lg-6">
                            <div class="card ">
                                {{ Form::open(['route' => ['business.custom-js-setting', $business->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                                <div class="card-body min-296">
                                    <div class="">
                                        <h5 class="mt-3 mb-4">{{ __('Custom JS and CSS') }}</h5>
                                        <div class="row">
                                            <div class="col-md-12">
                                                {{ Form::label('customjs', __('Custom JS'), ['class' => 'form-label ']) }}
                                                {{ Form::textarea('customjs', $business->customjs, ['class' => 'form-control', 'rows' => 3, 'placeholder' => __('Custom JS')]) }}
                                                @error('customjs')
                                            ...
                                            <div class="col-md-12"><br>
                                                {{ Form::label('customcss', __('Custom CSS'), ['class' => 'form-label']) }}
                                                {{ Form::textarea('customcss', $business->customcss, ['class' => 'form-control', 'rows' => 3, 'placeholder' => __('Custom Css')]) }}
                                                @error('customcss')
                                                    <span class="invalid-about" role="alert">
                                                        <strong class="text-danger">{{ $message }}</strong>
                                                    </span>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card">
                                {{ Form::open(['route' => ['business.googlefont-setting', $business->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                                <div class="card-body">
                                    <div class="">
                                        <h5 class="mt-3 mb-4">{{ __('Google Fonts') }}</h5>
                                        <div class="row mt-2 mb-4">
                                            <div class="col-6">
                                                {{-- {{ Form::label('Google Fonts', __('Google Fonts'), ['class' => 'form-label']) }} --}}
                                                <!-- {{ Form::text('google_fonts', $business->google_fonts, ['class' => 'form-control', 'rows' => '3', 'placeholder' => __('Enter Google Fonts')]) }} -->
                                                <select type="text" name="google_fonts" class="form-control select2">
                                                    ...
                                                    @foreach (\App\Models\Utility::getfonts() as $k => $fonts)
                                                        <option value="{{ $k }}"
                                                            {{ $business->google_fonts == $k ? 'selected' : '' }}>
                                                            @if ($k == 'TimesNewRoman')
                                                                Times New Roman
                                                            @elseif($k == 'OpenSans')
                                                                Open Sans
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                {{ Form::open(['route' => ['business.password-setting', $business->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                                <div class="card-body">
                                    <div class="">
                                        <h5 class="mt-3 mb-4">{{ __('Password') }}</h5>
                                        <div class="row mt-2 mb-4">
                                            <div class="col-6">
                                            ...
                                            <div class="col-6">
                                                <div
                                                    ...
                                                    <input type="checkbox" data-toggle="switchbutton"
                                                        ...
                                                        {{ isset($business->enable_password) && $business->enable_password == 'on' ? 'checked="checked"' : '' }}>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                {{ Form::open(['route' => ['business.gdpr-setting', $business->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                                <div class="card-body">
                                    <div class="row">
                                        <h5 class="mt-3 mb-4 col-6">{{ __('GDPR Cookies') }}</h5>
                                        <div class="form-group col-6">
                                            {{-- {{ Form::label('gdpr_cookie', __('GDPR Cookie'), ['class' => 'form-control-label']) }} --}}
                                            <div
                                                ...
                                                <input type="checkbox" data-toggle="switchbutton" data-onstyle="primary"
                                                    ...
                                                    {{ isset($business['is_gdpr_enabled']) && $business['is_gdpr_enabled'] == 'on' ? 'checked="checked"' : '' }}>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group gdpr_cookie_text">
                                        <textarea id="btn" type="text" name="cookie_text" class="form-control emojiarea" rows="4"
                                            style="height: auto"
                                            value="{{ isset($business['gdpr_text']) && $business['gdpr_text'] ? $business['gdpr_text'] : '' }}"
                                            placeholder="{{ isset($business['gdpr_text']) && $business['gdpr_text'] ? $business['gdpr_text'] : '' }}">{{ isset($business['gdpr_text']) && $business['gdpr_text'] ? $business['gdpr_text'] : '' }}</textarea>
                                    </div>    
                        ...
                        <div id="showbranding">
                            <div class="row">
                                <div class="col-lg-12" id="branding-div">
                                    <div class="card" >
                                        {{ Form::open(['route' => ['business.branding-setting', $business->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                                        <div class="card-body">
                                            <div class="row">
                                                <h5 class="mt-3 mb-4 col-6">{{ __('Branding') }}</h5>
                                                <div class="form-group col-6">
                                                    <div
                                                        class="d-flex align-items-center  justify-content-between border-0 mt-3 py-2 borderleft float-end">
                                                        <input type="checkbox" data-toggle="switchbutton" data-onstyle="primary"
                                                            name="branding" id="branding"
                                                            {{ isset($business['is_branding_enabled']) && $business['is_branding_enabled'] == 'on' ? 'checked="checked"' : '' }}>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group branding_text">
                                                <textarea id = "{{$stringid . '_branding'}}" type="text" name="branding_text" class="form-control emojiarea" rows="4"
                                                    style="height: auto" {{$business->branding}}
                                                    value="{{ isset($business['branding_text']) && $business['branding_text'] ? $business['branding_text'] : '' }}"
                                                    placeholder="{{ isset($business['branding_text']) && $business['branding_text'] ? $business['branding_text'] : '' }}">{{ isset($business['branding_text']) && $business['branding_text'] ? $business['branding_text'] : '' }}</textarea> 
                                            </div>    
                                            <div class="row card-footer ">
                                                <div class="col-12">
                                                    <button type="submit"
                                    ...
                                    <div class="card">
                                        <div class="col-12 pt-2 pb-4 ">
                                            <div class="card-body ml-3">
                                                <ul class="list-group sortable">
                                                    ...
                                                    @for ($i = 1; $i < 10; $i++)
                                                        @foreach ($card_theme->order as $order_key => $order_value)
                                                            @if ($i == $order_value)
                                                                <li class="list-group-item" data-id="{{ $order_key }}">
                                                                    <div class="row">
                                                                        @if ($order_key == 'scan_me')
                                                                            <div class="col-6 text-xs text-dark">
                                                                                <h6><i class="fas fa-crosshairs">&nbsp;&nbsp;&nbsp;{{ __('Scan Me') }}</i></h6>
                                                                            </div>
                                                                        @elseif($order_key == 'contact_info')
                                                                            <div class="col-6 text-xs text-dark">
                                                                                <h6><i class="fas fa-crosshairs">&nbsp;&nbsp;&nbsp;{{ __('Contact Info') }}</i></h6>
                                                                            </div>
                                                                        @elseif($order_key == 'bussiness_hour')
                                                                            <div class="col-6 text-xs text-dark">
                                                                                <h6><i class="fas fa-crosshairs">&nbsp;&nbsp;&nbsp;{{ __('Business Hour') }}</i></h6>
                                                                            </div>
                                                                        @elseif($order_key == 'custom_html')
                                                                            <div class="col-6 text-xs text-dark">
                                                                                <h6><i class="fas fa-crosshairs">&nbsp;&nbsp;&nbsp;{{ __('Custom HTML') }}</i></h6>
                                                                            </div>
                                                                        @elseif($order_key == 'branding')
                                                                            <div class="col-6 text-xs text-dark">
                                                                                <h6><i class="fas fa-crosshairs">&nbsp;&nbsp;&nbsp;{{ __('Branding') }}</i></h6>
                                                                            </div>
                                                                        @else
                                                                            <div class="col-6 text-xs text-dark">
                                                                                <h6><i class="fas fa-crosshairs">&nbsp;&nbsp;&nbsp;{{ ucfirst($order_key) }}</i></h6>
                                                                            </div>
                                                                        @endif
                                                ...
                                                <p class="mt-4">
                                                    {{ __('Note: You can easily order change of card blocks using drag & drop.') }}
                                                </p>
                                            </div>
                                            <div class="card-footer mt-4 ">
                                                <div class="col-12 text-right">
                                                    <button type="submit" class="btn btn-primary me-2 float-end"
                                                        id="btnSubmit">{{ __('Save changes') }}</button>
                                                </div>
                                            </div><br><br>
                                        </div>
                                        {{ Form::close() }}
