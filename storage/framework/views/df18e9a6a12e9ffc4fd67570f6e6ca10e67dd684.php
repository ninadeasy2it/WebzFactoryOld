...
<head>
    ...
    <?php if(isset($is_slug)): ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme5/css/bootstrap.min.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme5/modal/bootstrap.min.css')); ?>">
        <script src="<?php echo e(asset('custom/theme5/modal/jquery.min.js')); ?>"></script>
        <script src="<?php echo e(asset('custom/theme5/modal/bootstrap.min.js')); ?>"></script>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme5/fontawesome-free/css/all.min.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/css/emojionearea.min.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('assets/css/plugins/animate.min.css')); ?>" />
    <?php endif; ?>
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme5/css/styles/' . $business->theme_color . '/style.css')); ?>">
    <?php if(isset($is_slug)): ?>
                                ...
                                <div class="profile-head">
                                    <div class="align-items-center justify-content-center profile-head-main">
                                        <div class="profile-qr-code">
                                                ...
                                                <img src="<?php echo e(isset($business->logo) && !empty($business->logo) ? $logo . '/' . $business->logo : asset('custom/img/logo-placeholder-image-2.png')); ?>" id="business_logo_preview" alt="user" class="img-fluid">
                                        </div>
                                        <div class="vcard-description">
                                            <h1 id="<?php echo e($stringid . '_title'); ?>_preview"><?php echo e($business->title); ?>

                                            </h1>
                                            <h6 id="<?php echo e($stringid . '_designation'); ?>_preview">
                                                <?php echo e($business->designation); ?></h6>
                                            <p id="<?php echo e($stringid . '_subtitle'); ?>_preview">
                                                <?php echo e($business->sub_title); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="make-an-appointment d-flex mr-2">
                                    <span class="w-100" tabindex="0" data-toggle="tooltip"
                                        ...
                                        <button type="button"
                                            ...
                                            <img src="<?php echo e(asset('custom/theme5/icon/save.svg')); ?>" alt="folder"
                                                class="img-fluid">
                                ...
                                <div class="make-an-appointment d-flex mr-2">
                                    <span class="w-100" tabindex="0" data-toggle="tooltip"
                                        ...
                                        <button type="button"
                                            ...
                                            <img src="<?php echo e(asset('custom/theme5/icon/share.svg')); ?>" alt="signout"
                                                class="img-fluid">
                                            <!-- <h4 class="text-white"><?php echo e(__('Share card')); ?></h4> -->
                                        </button>
                                    </span>
                                </div>
                                <div class="make-an-appointment d-flex mr-2">
                                    <span class="w-100" tabindex="0" data-toggle="tooltip"
                                        ...
                                        <button type="button"
                                            ...
                                            <img src="<?php echo e(asset('custom/theme5/icon/call.svg')); ?>" alt="folder"
                                                class="img-fluid">
                                            <!-- <h4><?php echo e(__('Save card')); ?></h4> -->
                                        </button>
                                    </span>
                            ...
                            <div class="card-contact-header">
                                <div class="d-flex align-items-center justify-content-start">
                                    <div class="contact-text">
                                        <h3 class="text-white"><?php echo e(__('Social')); ?></h3>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <?php $__currentLoopData = $social_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social_key => $social_val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php $__currentLoopData = $social_val; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social_key1 => $social_val1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($social_key1 !== 'id'): ?>
                                                            <div class="col-3 socials_<?php echo e($loop->parent->index + 1); ?>"
                                                                id="socials_<?php echo e($loop->parent->index + 1); ?>">
                                                                <div class="social-image-icon">
                                                                    <a href="<?php echo e($social_val1); ?>">
                                                                        <img src="<?php echo e(asset('custom/theme5/icon/' . $color . '/social/' . strtolower($social_key1) . '.svg')); ?>"
                                ...
                                <div class="card-contact business-hour-bg" id="business-hours-div">
                                    <div class="card-contact-header">
                                        <ul>
                                            <li class="d-flex align-items-center justify-content-start">
                                                <div class="contact-text">
                                                    <h3 class="text-white"><?php echo e(__('Business Hours')); ?></h3>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                                                    ...
                                                                    <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="image-icon">
                                                                                <img src="<?php echo e(asset('custom/theme5/icon/' . $color . '/contact/' . strtolower($key1) . '.svg')); ?>"
                                                                                    alt="<?php echo e($key1); ?>"
                                                                                    class="img-fluid">
                                                                            </div>
                                                                            <div class="contact-text">
                            ...
                            <?php if($order_key == 'more'): ?>
                                <div class="card-contact banner-card-header">
                                    <div
                                        ...
                                        <div class="make-an-appointment d-flex mr-2">
                                            <span class="w-100" tabindex="0" data-toggle="tooltip"
                                                ...
                                                <button type="button"
                                                    class="make-an-appointment-btn-main d-flex align-items-center justify-content-center w-100 save-card"
                                                    onclick="location.href = '<?php echo e(route('bussiness.save', $business->slug)); ?>'">
                                                    <img src="<?php echo e(asset('custom/theme5/icon/save.svg')); ?>"
                                        ...
                                        <div class="make-an-appointment d-flex  mr-2">
                                            <span class="w-100" tabindex="0" data-toggle="tooltip"
                                                ...
                                                <button type="button"
                                                    class="border-dark make-an-appointment-btn-main d-flex align-items-center justify-content-center w-100 bg-transparent"
                                                    data-toggle="modal" data-target="#myModal">
                                                    <img src="<?php echo e(asset('custom/theme5/icon/signout.svg')); ?>"
                                        ...
                                        <img src="<?php echo e(asset('custom/theme5/icon/call.svg')); ?>" alt="folder" class="img-fluid">
                                         <h4><?php echo e(__('Save card')); ?></h4>
                                    </button> -->
                                                <button type="button"
                                                    class="make-an-appointment-btn-main d-flex align-items-center justify-content-center w-100 save-card"
                                                    data-toggle="modal" data-target="#mycontactModal">
                                                    <img src="<?php echo e(asset('custom/theme5/icon/call.svg')); ?>"
                                                        alt="folder" class="img-fluid">
                                                    <!-- <h4><?php echo e(__('Save card')); ?></h4> -->
                                                </button>
                                            </span>
                ...
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        ...
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center"
                            data-dismiss="modal">
                            <img src="<?php echo e(asset('custom/theme5/icon/close.svg')); ?>" alt="back"
                                class="img-fluid">
                        </button>
                    </div>
                </div>
            ...
            <div class="modal-content">
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center"
                            data-dismiss="modal">
                            <img src="<?php echo e(asset('custom/theme5/img/back.svg')); ?>" alt="back"
                                class="img-fluid">
                        </button>
                        <h4 class="modal-title" style="color:black;"><?php echo e(__('Share this card')); ?></h4>
...
<?php /**PATH C:\wamp64\www\WebzFactoryOld\resources\views/card/theme5/index.blade.php ENDPATH**/ ?>