...
<head>
    ...
    <?php if(isset($is_slug)): ?>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme1/css/bootstrap.min.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme1/modal/bootstrap.min.css')); ?>">
        <script src="<?php echo e(asset('custom/theme1/modal/jquery.min.js')); ?>"></script>
        <script src="<?php echo e(asset('custom/theme1/modal/bootstrap.min.js')); ?>"></script>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme1/css/styles/'.$business->theme_color.'/style.css')); ?>">
    <?php if(isset($is_slug)): ?>
...
<body class="tech-card-body" id="boxes">
                        ...
                        <?php if($j == $order_value): ?>     
                                                ...
                                                <?php if(isset($contactinfo['is_enabled']) && $contactinfo['is_enabled'] == '1'): ?>
                                                    <?php $__currentLoopData = $contactinfo_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>    
                                                        <?php $__currentLoopData = $val; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key1 => $val1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <?php endif; ?>
                                                            <?php if($key1 != 'id'): ?>  
                                                                <li class="d-flex align-items-center justify-content-center" id="contact_<?php echo e($loop->parent->index+1); ?>">
                                                                    <div class="image-icon">
                                                                        <img src="<?php echo e(asset('custom/theme1/icon/'.$color.'/'.strtolower($key1).'.svg')); ?>"  class="img-fluid">
                                                                    </div>
                                ...
                                <div class="card-detail" id="business-hours-div"><br><br>
                                    <div class="text-center card-business-hours">
                                        <div class="business-hours-image image-icon contact-icon">
                                            <img src="<?php echo e(asset('custom/theme1/icon/'.$color.'/clock.svg')); ?>" alt="clock" class="img-fluid">
                                        </div>
                                        <h4><?php echo e(__('Business Hours')); ?></h4>
                                        <ul class="pl-5">
                                ...
                                <div class="card-detail card-business-date" id="appointment-div"><br><br>
                                    <div class="text-center card-business-hours ">
                                        <div class="image-icon contact-icon">
                                            <img src="<?php echo e(asset('custom/theme1/icon/'.$color.'/calendar.svg')); ?>" alt="calendar" class="img-fluid">
                                        </div>
                                        <h3><?php echo e(__('Make an')); ?> <span> <?php echo e(__('appointment')); ?> </span></h3>
                            ...
                            <?php if($order_key == 'service'): ?>
                                <div class="card-detail card-business-date" id="services-div"><br><br>
                                    <div class="text-center card-business-hours">
                                        <div class="image-icon contact-icon">
                                            <img src="<?php echo e(asset('custom/theme1/icon/'.$color.'/phone.svg')); ?>" alt="phone" class="img-fluid">
                                        </div>
                                        <h3><span> <?php echo e(__('Services')); ?> </span></h3>
                            ...
                            <?php if($order_key == 'more'): ?>
                                <div class="card-detail card-business-date"><br><br>
                                    <div class="text-center card-business-hours">
                                        <div class="image-icon contact-icon">
                                            <img src="<?php echo e(asset('custom/theme1/icon/'.$color.'/bookmark.svg')); ?>" alt="bookmark" class="img-fluid">
                                        </div>
                                        <h3><span> <?php echo e(__('More')); ?> </span></h3>
                                        <div class="make-an-appointment d-flex mb-3">
                                            <div class="w-100">
                                                <button type="button"
                                                    ...
                                                    <img src="<?php echo e(asset('custom/theme1/icon/'.$color.'/folder.svg')); ?>" alt="folder" class="img-fluid">
                                                    <h4><a class="text-black" href="<?php echo e(route('bussiness.save',$business->slug)); ?>"><?php echo e(__('Save card')); ?></a></h4>
                                                </button>
                                            </div>
                                        </div>
                                        <div class="make-an-appointment d-flex mb-3">
                                        ...
                                        <div class="make-an-appointment d-flex mb-3">
                                            <div class="w-100">
                                                <button type="button"
                                                    ...
                                                    <img src="<?php echo e(asset('custom/theme1/icon/'.$color.'/phone.svg')); ?>" alt="signout" class="img-fluid">
                            ...
                            <?php if($order_key == 'testimonials'): ?>
                                <div class="card-detail card-business-date mb-2" id="testimonials-div">
                                    <div class="text-center card-business-hours pb-0">
                                        <div class="image-icon contact-icon">
                                            <img src="<?php echo e(asset('custom/theme1/icon/'.$color.'/user.svg')); ?>" alt="user" class="img-fluid">
                                        </div>
                                        <h3><span> <?php echo e(__('Testimonials')); ?> </span></h3>
                                        <div class="container-lg">
                                                ...
                                                <div class="col-lg-6 pr-8 pl-0 res-pr-0" id="testimonials_<?php echo e($testimonials_row_no); ?>">
                                                    <div class="service-card testimonials-card">
                                                        <div class="service-card-img ">
                                                            ...
                                                            <img id="<?php echo e('t_image'.$t_image_count.'_preview'); ?>" src="<?php echo e(!empty($testi_content->image) ? $image . '/' . $testi_content->image : $image . 'testimonials_images/' .$testi_content->image); ?>"alt="user" class="img-fluid">
                                                        </div>
                                                        <div class="service-card-heading">
                                                            <h3>
                            ...
                            <div class="social-icon mb-2" id="social-div">
                                <div class="text-center card-business-hours pb-20">
                                    <div class="image-icon contact-icon">
                                        <img src="<?php echo e(asset('custom/theme1/icon/'.$color.'/share.svg')); ?>" alt="share" class="img-fluid">
                                    </div>
                                    <h3><span> <?php echo e(__('Social')); ?> </span></h3>
                                    <div class="container-lg">
                                        <div class="row">
                                                        ...
                                                        <?php $__currentLoopData = $social_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social_key => $social_val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php $__currentLoopData = $social_val; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social_key1 => $social_val1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <?php if($social_key1 != 'id'): ?>
                                                                    <div class="col-2 <?php echo e('socials_'.$social_no); ?>">
                                                                        <span id="<?php echo e('socials_'.$social_no); ?>">
                                                                            <a href="<?php echo e(url($social_val1)); ?>" id="<?php echo e('social_link_'.$social_no.'_href_preview'); ?>" class="<?php echo e('social_link_'.$social_no.'_href_preview'); ?>" target="_blank"> 
                                                                                <div class="image-icon">
                                                                                    <img src="<?php echo e(asset('custom/theme1/icon/'.$color.'/'.strtolower($social_key1).'.svg')); ?>" alt="twitter" class="img-fluid">
                                                                                </div>
                                                                            </a>
                                                                        </span>
                                                                    </div>
                ...
                <div class="modal-body px-4">
                    <form class="appointment-form">
                      ...
                      <div class="form-group">
                       ...
                       <input type="number" name="phone" placeholder="<?php echo e(__('Enter your phone no.')); ?>" class="form-control app_phone" id="recipient-name">
                       <div class="">
        ...
        $( `#makeappointment`).click(function() {
            ...
            if(date == ""){
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    data: {
                        "name": name,"email": email,"phone":phone,"date": date,"time": time,"business_id": business_id, "_token": "<?php echo e(csrf_token()); ?>",
                    },
   ...
   <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=0000&ev=PageView&noscript=<?php echo e($business->fbpixel_code); ?>"/></noscript>
    <!-- Custom Code -->
    <script type="text/javascript">    
...
<?php /**PATH C:\wamp64\www\WebzFactoryOld\resources\views/card/theme1/index.blade.php ENDPATH**/ ?>