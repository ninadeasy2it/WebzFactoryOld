...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme3/fontawesome-free/css/all.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('custom/css/emojionearea.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/plugins/animate.min.css')); ?>" />
    <?php endif; ?>
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme3/css/styles/'.$business->theme_color.'/style.css')); ?>">
    <?php if(isset($is_slug)): ?>
                ...
                <div class="bg-white overflow-hidden">
                    ...
                    <?php $__currentLoopData = $card_theme->order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order_key => $order_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($j == $order_value): ?>
                                                            ...
                                                            <?php if($key1 != 'id'): ?>
                                                                <li class="d-flex align-items-center justify-content-start" id="contact_<?php echo e($loop->parent->index+1); ?>">
                                                                    <div class="image-icon">
                                                                        <img src="<?php echo e(asset('custom/theme3/icon/contact/'.strtolower($key1).'.svg')); ?>" alt="<?php echo e($key1); ?>" class="img-fluid">
                                                                    </div>
                                            ...
                                            <div class="make-an-appointment d-flex">
                                                ...
                                                <div class="make-an-appointment-btn">
                                                    <button type="button" data-toggle="modal" data-target="#appointment-modal"
                                                        ...
                                                        <img src="<?php echo e(asset('custom/theme3/icon/calender-black.svg')); ?>" alt="calender-black"
                                                            class="img-fluid">
                            ...
                            <?php endif; ?>
                            <?php if($order_key == 'testimonials'): ?><br>
                                <div class="card-detail card-business-date mb-2" id="testimonials-div"><br><br>
                                        ...
                                        <div class="make-an-appointment d-flex mb-3">
                                            <div class="w-100">
                                                <button type="button"
                                                    ...
                                                    <img src="<?php echo e(asset('custom/theme3/icon/save.svg')); ?>" alt="folder" class="img-fluid">
                                        ...
                                        <div class="make-an-appointment d-flex mb-3">
                                            <div class="w-100">
                                                <button type="button"
                                                    ...
                                                    <img src="<?php echo e(asset('custom/theme3/icon/share.svg')); ?>" alt="signout" class="img-fluid">
                                        ...
                                        <div class="make-an-appointment d-flex mb-3">
                                            <div class="w-100">
                                                <button type="button"
                                                    ...
                                                    <img src="<?php echo e(asset('custom/theme3/icon/Phone.svg')); ?>"  class="img-fluid">
                            ...
                            <div class="social-icon-section align-items-center justify-content-between" id="social-div">
                                <div class="card-contact">
                                    <div class="">
                                        <ul>
                                            <li class="d-flex align-items-center justify-content-start m-0">
                                                ...
                                                <div class="social-icon-main w-100 d-flex align-items-center justify-content-between " id="inputrow_socials_preview">
                                                    <?php $__currentLoopData = $social_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social_key => $social_val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php $__currentLoopData = $social_val; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social_key1 => $social_val1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <div class="social-image-icon socials_<?php echo e($loop->parent->index+1); ?>" id="socials_<?php echo e($loop->parent->index+1); ?>">
                                                                <a href="<?php echo e($social_val1); ?>" id="social_link_<?php echo e($loop->parent->index+1); ?>_href_preview" class="social_link_<?php echo e($loop->parent->index+1); ?>_href_preview" target="_blank">
                                                                    <img src="<?php echo e(asset('custom/theme3/icon/social/'.strtolower($social_key1).'.svg')); ?>" alt="<?php echo e($social_key1); ?>"
                                                                        class="img-fluid">
                                                                </a>
                                                            </div>
                                                            <?php endif; ?>
            ...
            <div class="modal-content">
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center"
                            data-dismiss="modal">
                            <img src="<?php echo e(asset('custom/theme3/img/back.svg')); ?>" alt="back" class="img-fluid">
                        </button>
                    ...
                    <div class="modal-body-section text-center">
                        <div class="qr-main-image">
                            <div class="qr-code-border">
                                <img src="<?php echo e(asset('custom/theme3/icon/left-top.svg')); ?>" alt="left-top" class="img-fluid left-top-border">
                                <img src="<?php echo e(asset('custom/theme3/icon/left-bottom.svg')); ?>" alt="left-bottom"
                                    class="img-fluid left-bottom-border">
                                <img src="<?php echo e(asset('custom/theme3/icon/right-top.svg')); ?>" alt="right-top" class="img-fluid right-top-border">
                                <img src="<?php echo e(asset('custom/theme3/icon/right-bottom.svg')); ?>" alt="right-bottom"
...
<?php /**PATH C:\wamp64\www\WebzFactoryOld\resources\views/card/theme3/index.blade.php ENDPATH**/ ?>