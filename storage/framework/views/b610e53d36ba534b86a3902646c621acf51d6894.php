                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    ...
                                    <div class="border-0 pb-0 ">
                                        <h5 class="mb-0">
                                            <div class="badge p-2 px-3 rounded bg-primary"><b><?php echo e(ucfirst($val->user_name)); ?></b></div>
                                        </h5>
                                    </div>
                                ...
                                <td class="align-middle">
                                    ...
                                    <div class="border-0 pb-0 ">
                                        <h5 class="mb-0">
                                            <div class="badge p-2 px-3 rounded bg-primary"><b><?php echo e($val->user_email); ?></b></div>
                                        </h5>
                                    </div>
