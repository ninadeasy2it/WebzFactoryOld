...
<script src="<?php echo e(asset('custom/js/summernote-ext-emoji.js')); ?>"></script>
 <script src="<?php echo e(asset('assets/js/plugins/bootstrap-switch-button.min.js')); ?>"></script>
 
 <script src="<?php echo e(asset('custom/libs/select2/dist/js/select2.full.min.js')); ?>"></script>
...
<!-- <script type="text/javascript">
  ...
  <?php /**PATH C:\wamp64\www\WebzFactoryOld\resources\views/partials/admin/footer.blade.php ENDPATH**/ ?>