...
<head>
    ...
    <?php if(isset($is_slug)): ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme10/css/bootstrap.min.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme10/modal/bootstrap.min.css')); ?>">
        <script src="<?php echo e(asset('custom/theme10/modal/jquery.min.js')); ?>"></script>
        <script src="<?php echo e(asset('custom/theme10/modal/bootstrap.min.js')); ?>"></script>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme10/fontawesome-free/css/all.min.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/css/emojionearea.min.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('assets/css/plugins/animate.min.css')); ?>" />
    <?php endif; ?>

    <link rel="stylesheet" href="<?php echo e(asset('custom/theme10/css/styles/' . $business->theme_color . '/style.css')); ?>">
    <?php if(isset($is_slug)): ?>
                                                        ...
                                                        <?php if($key1 != 'id'): ?>
                                                            <li class=""
                                                                ...
                                                                <div class="image-icon">
                                                                    <img src="<?php echo e(asset('custom/theme10/icon/' . $color . '/contact/' . strtolower($key1) . '.svg')); ?>"
                                                                        alt="<?php echo e($key1); ?>" class="img-fluid">
                                                                </div>
                                                                <div class="contact-text">
                                                                    <?php if($key1 == 'Web_url'): ?>
                                                                        <p><?php echo e(__('Web Url')); ?></p>
                                                                    <?php else: ?>
                                                                        <p><?php echo e(__($key1)); ?></p>
                                                                    <?php endif; ?>
                            ...
                            <?php if($order_key == 'description'): ?>
                                <div class="bg-white white-section description-div">
                                    <div class="pb-4 text-center vcard-description">
                                        <p id="<?php echo e($stringid . '_desc'); ?>_preview" class="desc">
                                                        ...
                                                        <?php if(!is_null($appoinment_hours)): ?>
                                                            <?php $__currentLoopData = $appoinment_hours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $hour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <div class="radio pr-8"
                                                                    ...
                                                                    <input id="radio-<?php echo e($radiocount); ?>"
                                                ...
                                                <div class="make-an-appointment d-flex w-100">
                                                    ...
                                                    <div class="make-an-appointment-btn w-100">
                                                        <button type="button" data-toggle="modal"
                                                            ...
                                                            <img src="<?php echo e(asset('custom/theme10/icon/calender-black.png')); ?>"
                                                        ...
                                                        <div class="col-lg-6 pr-8 pl-0 res-pr-0"
                                                            ...
                                                            <div class="service-card testimonials-card mb-0 pb-0">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <h3 class="text-dark">
                                                                        <?php echo e($testi_content->rating); ?>/5
                                                                    </h3>
                                                    ...
                                                    <?php $__currentLoopData = $social_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social_key => $social_val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php $__currentLoopData = $social_val; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social_key1 => $social_val1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($social_key1 != 'id'): ?>
                                                                <div
                                                                    class="col-3 socials_<?php echo e($loop->parent->index + 1); ?>">
                                                                    <div class="">
                                                                        <a href="<?php echo e($social_val1); ?>"
                                                                            target="_blank">
                                                                            <img src="<?php echo e(asset('custom/theme10/icon/' . $color . '/social/' . strtolower($social_key1) . '.svg')); ?>"
                                        ...
                                        <div class="make-an-appointment d-flex">
                                            <span class="w-100" tabindex="0" data-toggle="tooltip"
                                                ...
                                                <button type="button"
                                                    ...
                                                    <img src="<?php echo e(asset('custom/theme10/icon/save.svg')); ?>"
                                        ...
                                        <div class="make-an-appointment d-flex">
                                            <span class="w-100" tabindex="0" data-toggle="tooltip"
                                                ...
                                                <button type="button"
                                                    ...
                                                    <img src="<?php echo e(asset('custom/theme10/icon/signout.svg')); ?>"
                                                        alt="signout" class="img-fluid">
                                                    <!-- <h4 class="text-dark"><?php echo e(__('Share card')); ?></h4> -->
                                                </button>
                                            </span>
                                        </div>
                                        <div class="make-an-appointment d-flex">
                                            <span class="w-100" tabindex="0" data-toggle="tooltip"
                                                ...
                                                <button type="button"
                                                    ...
                                                    <img src="<?php echo e(asset('custom/theme10/icon/white/Phone.svg')); ?>"
                                                        alt="folder" class="img-fluid">
                                                    <!-- <h4 class="text-white"><?php echo e(__('Save card')); ?></h4> -->
                                                </button>
                                            </span>
                ...
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        ...
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center"
                            data-dismiss="modal">
                            <img src="<?php echo e(asset('custom/theme10/icon/close.svg')); ?>" alt="back"
                                class="img-fluid">
                        </button>
            ...
            <div class="modal-content">
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center"
                            data-dismiss="modal">
                            <img src="<?php echo e(asset('custom/theme10/img/back.svg')); ?>" alt="back" class="img-fluid">
                        </button>
                    ...
                    <div class="modal-body-section text-center">
                        <div class="qr-main-image">
                            <div class="qr-code-border">
                                <img src="<?php echo e(asset('custom/theme10/icon/left-top.svg')); ?>" alt="left-top"
                                    class="img-fluid left-top-border">
                                <img src="<?php echo e(asset('custom/theme10/icon/left-bottom.svg')); ?>" alt="left-bottom"
                                    class="img-fluid left-bottom-border">
                                <img src="<?php echo e(asset('custom/theme10/icon/right-top.svg')); ?>" alt="right-top"
                                    class="img-fluid right-top-border">
                                <img src="<?php echo e(asset('custom/theme10/icon/right-bottom.svg')); ?>" alt="right-bottom"
...
<?php /**PATH C:\wamp64\www\WebzFactoryOld\resources\views/card/theme10/index.blade.php ENDPATH**/ ?>