...
<head>
    ...
    <?php if(isset($is_slug)): ?>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme9/css/bootstrap.min.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme9/modal/bootstrap.min.css')); ?>">
        <script src="<?php echo e(asset('custom/theme9/modal/jquery.min.js')); ?>"></script>
        <script src="<?php echo e(asset('custom/theme9/modal/bootstrap.min.js')); ?>"></script>
        <link rel="stylesheet" href="<?php echo e(asset('custom/theme9/fontawesome-free/css/all.min.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('custom/css/emojionearea.min.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('assets/css/plugins/animate.min.css')); ?>" />
    <?php endif; ?>
    <link rel="stylesheet" href="<?php echo e(asset('custom/theme9/css/styles/' . $business->theme_color . '/style.css')); ?>">
    <?php if(isset($is_slug)): ?>
                                ...
                                <div class="profile-head">
                                    <div class="align-items-center justify-content-center profile-head-main">
                                        <div class="vcard-description">
                                            ...
                                            <p id="<?php echo e($stringid . '_subtitle'); ?>_preview" class="text-white"><?php echo e($business->sub_title); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="make-an-appointment d-flex mr-2">
                                                <span class="w-100" tabindex="0" data-toggle="tooltip"
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        <img src="<?php echo e(asset('custom/theme9/icon/save.svg')); ?>"
                                                            alt="folder" class="img-fluid">
                                                        <!-- <h4 class="text-white"><?php echo e(__('Save card')); ?></h4> -->
                                                    </button>
                                                </span>
                                            </div>
                                            <div class="make-an-appointment d-flex mr-2">
                                                <span class="w-100" tabindex="0" data-toggle="tooltip"
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        <img src="<?php echo e(asset('custom/theme9/icon/signout.svg')); ?>"
                                                            alt="signout" class="img-fluid">
                                                        <!-- <h4 class=""><?php echo e(__('Share card')); ?></h4> -->
                                                    </button>
                                                </span>
                                            </div>
                                            <div class="make-an-appointment d-flex mr-2">
                                                <span class="w-100" tabindex="0" data-toggle="tooltip"
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        <img src="<?php echo e(asset('custom/theme9/icon/call.svg')); ?>"
                                                            alt="folder" class="img-fluid">
                                                        <!-- <h4 class="text-white"><?php echo e(__('Save card')); ?></h4> -->
                                                    </button>
                                                </span>
                                ...
                                <div class="card-contact w-100 d-inline-block pt-3">
                                    <div class="scan_me_main_section">
                                        <div class="scan_me_section">
                                            <div class="contact-text">
                                                <h3 class=""><?php echo e(__('Scan me')); ?></h3>
                                            </div>
                                ...
                                <div class="card-contact" id="appointment-div">
                                    <div class="card-contact-header">
                                        <ul>
                                            <li class=" d-flex align-items-center justify-content-start">
                                                <div class="contact-text">
                                                    <h3> <span><?php echo e(__('Make an')); ?> </span> <?php echo e(__('appointment')); ?>
                                            ...
                                            <div class="make-an-appointment d-flex w-100 p-0">
                                                <div class="make-an-appointment-btn">
                                                    <button type="button" data-toggle="modal"
                                                        ...
                                                        <h4 class="text-white"><?php echo e(__('Make an appointment')); ?></h4>
                                                    </button>
                                                </div>
                                            </div>
                                        </form>
                                    ...
                                    <div class="card-contact">
                                        <div class="card-contact-header">
                                            <ul>
                                                <li class="d-flex align-items-center justify-content-start">
                                                    <div class="contact-text">
                                                        <h3><?php echo e(__('Contact informations')); ?></h3>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                                            ...
                                                            <div class="col-lg-6 pr-8 pl-0 res-pr-0"
                                                                ...
                                                                <div class="service-card testimonials-card mb-0 pb-0">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <h3 class="text-dark">
                                                                            <span
                                                                                class="stars<?php echo e($testimonials_row_no); ?>"><?php echo e($testi_content->rating); ?></span>/5
                                                                        </h3>
                                            ...
                                            <div class="container-lg">
                                                <div class="row justify-content-center inputrow_socials_preview">
                                                    <?php $__currentLoopData = $social_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social_key => $social_val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php $__currentLoopData = $social_val; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social_key1 => $social_val1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($social_key1 != 'id'): ?>
                                                                <div class="col-1 p-0 socials_<?php echo e($loop->parent->index + 1); ?>"
                ...
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        ...
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center"
                            data-dismiss="modal">
                            <img src="<?php echo e(asset('custom/theme9/icon/close.svg')); ?>" alt="back" class="img-fluid">
                        </button>
                    </div>
                </div>
            ...
            <div class="modal-content">
                <div class="modal-header border-0">
                    <div class="modal-custom-header d-flex align-items-center justify-content-between w-100">
                        <button type="button" class="back-btn d-flex align-items-center justify-content-center"
                            data-dismiss="modal">
                            <img src="<?php echo e(asset('custom/theme9/img/back.svg')); ?>" alt="back" class="img-fluid">
                        </button>
                    ...
                    <div class="modal-body-section text-center">
                        <div class="qr-main-image">
                            <div class="qr-code-border">
                                <img src="<?php echo e(asset('custom/theme9/icon/left-top.svg')); ?>" alt="left-top"
                                    class="img-fluid left-top-border">
                                <img src="<?php echo e(asset('custom/theme9/icon/left-bottom.svg')); ?>" alt="left-bottom"
                                    class="img-fluid left-bottom-border">
                                <img src="<?php echo e(asset('custom/theme9/icon/right-top.svg')); ?>" alt="right-top"
                                    class="img-fluid right-top-border">
                                <img src="<?php echo e(asset('custom/theme9/icon/right-bottom.svg')); ?>" alt="right-bottom"
                    ...
                    <form action="<?php echo e(route('contacts.store')); ?>" method="post">
                        ...
                        <div class="form-group">
                            <label for="recipient-name"
                                class="col-form-label text-white"><?php echo e(__('Name')); ?>:</label>
                            <input type="text" name="name" placeholder="<?php echo e(__('Enter your name')); ?>"
                                class="form-control" id="recipient-name">
                        </div>
                        <div class="form-group">
                            <label for="message-text" class="col-form-label text-white"><?php echo e(__('Email')); ?>:</label>
                            <input type="email" name="email" placeholder="<?php echo e(__('Enter your email')); ?>"
                                class="form-control" id="recipient-name">
                        </div>
                        <div class="form-group">
                            <label for="message-text" class="col-form-label text-white"><?php echo e(__('Phone')); ?>:</label>
                            <input type="text" name="phone" placeholder="<?php echo e(__('Enter your phone no.')); ?>"
                                class="form-control" id="recipient-name">
                        </div>

                        <div class="form-group">
                            <label for="message-text" class="col-form-label text-white"><?php echo e(__('Message')); ?>:</label>
...
<?php /**PATH C:\wamp64\www\WebzFactoryOld\resources\views/card/theme9/index.blade.php ENDPATH**/ ?>